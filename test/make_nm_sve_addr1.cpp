...
const uint64_t IMM13BIT =
    flagBit++; /** Test vector is {0, 1, ..., 4096, 8191 } */
const uint64_t IMM16BIT = flagBit++; /** Test vector is {0, 1, ..., 4096, 1<<13,
                                        1<<14, 1<<15, 1<<16-1 } */
...
const uint64_t FLOAT8BIT =
    flagBit++; /** Test vector is Table C-2- Floating-point constant values */
...
const uint64_t SPECIFIC64_4 =
    flagBit++; /** Test vector is generated on the fly. */
const uint64_t SPECIFIC32_5 =
    flagBit++; /** Test vector is generated on the fly. */
const uint64_t SPECIFIC64_5 =
    flagBit++; /** Test vector is generated on the fly. */
...
class Test {
  ...
  std::vector<std::string> tv_WNSP = {"w7", "w0",  "w1",  "w2", "w4",
                                      "w8", "w16", "w30", "wsp", "WReg(7)"};
  ...
  std::vector<std::string> tv_SPECIFIC32, tv_SPECIFIC64, tv_SPECIFIC32_1,
      ...
      tv_SPECIFIC64_3, tv_SPECIFIC32_4, tv_SPECIFIC64_4, tv_SPECIFIC32_5,
      tv_SPECIFIC64_5;
  std::vector<std::string> jtv_SPECIFIC32, jtv_SPECIFIC64, jtv_SPECIFIC32_1,
      ...
      jtv_SPECIFIC64_3, jtv_SPECIFIC32_4, jtv_SPECIFIC64_4, jtv_SPECIFIC32_5,
      jtv_SPECIFIC64_5;
  ...
  std::vector<std::string> jtv_PG_Z = {"p7/T_z", "p0/T_z", "p1/T_z", "p2/T_z",
                                       "p4/T_z"};
  std::vector<std::string> jtv_PG_ZM = {"p7/T_m", "p0/T_m", "p1/T_m", "p2/T_m",
                                        "p4/T_m", "p7/T_z", "p0/T_z", "p1/T_z",
                                        "p2/T_z", "p4/T_z"};
  ...
  std::vector<std::string> tv_PRFOP_SVE = {
      "PLDL1KEEP", "PLDL1STRM", "PLDL2KEEP", "PLDL2STRM",
      "PLDL3KEEP", "PLDL3STRM", "PSTL1KEEP", "PSTL1STRM",
      "PSTL2KEEP", "PSTL2STRM", "PSTL3KEEP", "PSTL3STRM"};
  std::vector<std::string> jtv_PRFOP_SVE = {
      "PLDL1KEEP_SVE", "PLDL1STRM_SVE", "PLDL2KEEP_SVE", "PLDL2STRM_SVE",
  ...
  std::vector<std::vector<std::string> *> tv_VectorsAs = {
      &tv_WREG,         &tv_XREG,         &tv_VREG,         &tv_WSP,
      &tv_XSP,          &tv_WNSP,         &tv_XNSP,         &tv_IMM0BIT,
      ...
      &tv_IMM5BIT_N,    &tv_IMM6BIT_N,    &tv_FLOAT8BIT,    &tv_ZREG,
      ...
      &tv_ZREG_B,       &tv_ZREG_H,       &tv_ZREG_S,       &tv_ZREG_D,
      &tv_ZREG_Q,       &tv_PREG_B,       &tv_PREG_H,       &tv_PREG_S,
      &tv_PREG_D,       &tv_PG_M,         &tv_PG_Z,         &tv_PG,
      &tv_PG_ZM,        &tv_PTR_O,        &tv_PTR_C,        &tv_BRA_O,
      &tv_BRA_C,        &tv_XTW,          &tv_PRFOP,        &tv_PRFOP_SVE,
      &tv_MUL_VL};
  std::vector<std::vector<std::string> *> tv_VectorsJit = {
      ...
      &tv_XSP,           &tv_WNSP,
      &tv_XNSP,          &tv_IMM0BIT,
      &tv_IMM1BIT,       &tv_IMM2BIT,
      &tv_IMM3BIT,       &tv_IMM4BIT,
      &tv_IMM5BIT,       &tv_IMM6BIT,
      &tv_IMM8BIT,       &tv_IMM12BIT,
      &tv_IMM13BIT,      &tv_IMM16BIT,
      &tv_IMM3BIT_N,     &tv_IMM4BIT_N,
      &tv_IMM5BIT_N,     &tv_IMM6BIT_N,
      &tv_FLOAT8BIT,     &tv_ZREG,
      &jtv_SPECIFIC32,   &jtv_SPECIFIC64,
      &jtv_SPECIFIC32_1, &jtv_SPECIFIC64_1,
      &jtv_SPECIFIC32_2, &jtv_SPECIFIC64_2,
      &jtv_SPECIFIC32_3, &jtv_SPECIFIC64_3,
      &jtv_SPECIFIC32_4, &jtv_SPECIFIC64_4,
      &jtv_SPECIFIC32_5, &jtv_SPECIFIC64_5,
      &jtv_SPECIFIC0,    &jtv_SPECIFIC1,
      &jtv_SPECIFIC2,    &jtv_SPECIFIC3,
      &jtv_SPECIFIC4,    &jtv_SPECIFIC5,
      &jtv_SPECIFIC6,    &jtv_SPECIFIC7,
      &tv_ZREG_B,        &tv_ZREG_H,
      &tv_ZREG_S,        &tv_ZREG_D,
      &tv_ZREG_Q,        &tv_PREG_B,
      &tv_PREG_H,        &tv_PREG_S,
...
public:
  ...
  */
  ...
  PUT1(SVE_contiguous_prefetch_scalar_plus_scalar0, NM("prfb"),
       OPS(PRFOP_SVE, PG, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_contiguous_prefetch_scalar_plus_scalar1, NM("prfh"),
       OPS(PRFOP_SVE, PG, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_contiguous_prefetch_scalar_plus_scalar2, NM("prfw"),
       OPS(PRFOP_SVE, PG, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_contiguous_prefetch_scalar_plus_scalar3, NM("prfd"),
  ...
  PUT4(SVE_32_bit_gather_prefetch_vector_plus_immediate0, NM("prfb"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, IMM5BIT, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, IMM5BIT, PTR_C));
  PUT4(SVE_32_bit_gather_prefetch_vector_plus_immediate1, NM("prfh"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC1, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC1, PTR_C));
  PUT4(SVE_32_bit_gather_prefetch_vector_plus_immediate2, NM("prfw"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC2, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC2, PTR_C));
  PUT4(SVE_32_bit_gather_prefetch_vector_plus_immediate3, NM("prfd"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC3, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC3, PTR_C));
  ...
  PUT2(SVE_32_bit_gather_load_vector_plus_immediate0,
       NM("ld1sb", "ldff1sb", "ld1b", "ldff1b"),
       OPS(ZREG_S, PG_Z, PTR_O, ZREG_S, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, ZREG_S, IMM5BIT, PTR_C));
  PUT2(SVE_32_bit_gather_load_vector_plus_immediate1,
       NM("ld1sh", "ldff1sh", "ld1h", "ldff1h"),
       OPS(ZREG_S, PG_Z, PTR_O, ZREG_S, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, ZREG_S, SPECIFIC1, PTR_C));
  PUT2(SVE_32_bit_gather_load_vector_plus_immediate2, NM("ld1w", "ldff1w"),
       OPS(ZREG_S, PG_Z, PTR_O, ZREG_S, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, ZREG_S, SPECIFIC2, PTR_C));
  ...
  PUT8(SVE_load_and_broadcast_element0, NM("ld1rb"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C));
  PUT2(SVE_load_and_broadcast_element1, NM("ld1rsw"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC2, PTR_C));
  PUT6(SVE_load_and_broadcast_element2, NM("ld1rh"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC1, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC1, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC1, PTR_C));
  PUT4(SVE_load_and_broadcast_element3, NM("ld1rsh"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC1, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC1, PTR_C));
  PUT4(SVE_load_and_broadcast_element4, NM("ld1rw"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC2, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC2, PTR_C));
  PUT6(SVE_load_and_broadcast_element5, NM("ld1rsb"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, IMM6BIT, PTR_C));
  PUT2(SVE_load_and_broadcast_element6, NM("ld1rd"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC3, PTR_C));
  ...
  PUT1(SVE_32_bit_gather_prefetch_scalar_plus_32_bit_scaled_offsets0,
       NM("prfb"), OPS(PRFOP_SVE, PG, PTR_O, XNSP, ZREG_S, XTW, PTR_C));
  ...
  PUT2(SVE_load_predicate_register0, NM("ldr"),
       OPS(SPECIFIC64_1, PTR_O, XNSP, PTR_C),
       OPS(SPECIFIC64_1, PTR_O, XNSP, SPECIFIC64, MULVL, PTR_C));

  void putSVE_load_predicate_register() { putSVE_load_predicate_register0(); }

  /*** SVE load vector register */
  PUT2(SVE_load_vector_register0, NM("ldr"), OPS(ZREG, PTR_O, XNSP, PTR_C),
       OPS(ZREG, PTR_O, XNSP, SPECIFIC64, MULVL));

  void putSVE_load_vector_register() { putSVE_load_vector_register0(); }
  ...
  PUT1(SVE_load_and_broadcast_quadword_scalar_plus_scalar0, NM("ld1rqb"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_load_and_broadcast_quadword_scalar_plus_scalar1, NM("ld1rqh"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C));
  PUT1(SVE_load_and_broadcast_quadword_scalar_plus_scalar2, NM("ld1rqw"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, SPECIFIC2, PTR_C));
  PUT1(SVE_load_and_broadcast_quadword_scalar_plus_scalar3, NM("ld1rqd"),
  ...
  PUT4(SVE_contiguous_load_scalar_plus_scalar0, NM("ld1b"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, XREG, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, XREG, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_contiguous_load_scalar_plus_scalar1, NM("ld1sw"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, SPECIFIC2, PTR_C));
  PUT3(SVE_contiguous_load_scalar_plus_scalar2, NM("ld1h"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C));
  PUT2(SVE_contiguous_load_scalar_plus_scalar3, NM("ld1sh"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C));
  PUT2(SVE_contiguous_load_scalar_plus_scalar4, NM("ld1w"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, SPECIFIC2, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, SPECIFIC2, PTR_C));
  PUT3(SVE_contiguous_load_scalar_plus_scalar5, NM("ld1sb"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_contiguous_load_scalar_plus_scalar6, NM("ld1d"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, SPECIFIC3, PTR_C));
  ...
  PUT8(SVE_contiguous_first_fault_load_scalar_plus_scalar0, NM("ldff1b"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, SPECIFIC64, PTR_C),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, SPECIFIC64_1, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC64, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC64_1, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC64, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC64_1, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64_1, PTR_C));
  PUT2(SVE_contiguous_first_fault_load_scalar_plus_scalar1, NM("ldff1sw"),
       // Following test gives ommited operands to xbyak_aarch64,
       // full operands to aarch64-linux-as. as can't handle with ommited
       // operands.
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64_2, SPECIFIC5, PTR_C),
       // Following test gives full operands to both of xbyak_aarch64 and
       // aarch64-linux-as.
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64_1, SPECIFIC2, PTR_C));
  PUT6(SVE_contiguous_first_fault_load_scalar_plus_scalar2, NM("ldff1h"),
       // Following test gives ommited operands to xbyak_aarch64,
       // full operands to aarch64-linux-as. as can't handle with ommited
       // operands.
  ...
  PUT4(SVE_contiguous_first_fault_load_scalar_plus_scalar3, NM("ldff1sh"),
       // Following test gives ommited operands to xbyak_aarch64,
       // full operands to aarch64-linux-as. as can't handle with ommited
       // operands.
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64_2, SPECIFIC4, PTR_C),
       ...
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64_1, SPECIFIC1, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC64_1, SPECIFIC1, PTR_C));
  PUT4(SVE_contiguous_first_fault_load_scalar_plus_scalar4, NM("ldff1w"),
       // Following test gives ommited operands to xbyak_aarch64,
       // full operands to aarch64-linux-as. as can't handle with ommited
       // operands.
       ...
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC64_1, SPECIFIC2, PTR_C));
  PUT6(SVE_contiguous_first_fault_load_scalar_plus_scalar5, NM("ldff1sb"),
       // Following test gives ommited operands to xbyak_aarch64,
       // full operands to aarch64-linux-as. as can't handle with ommited
       // operands.
       ...
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC64_1, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC64_1, PTR_C));
  PUT2(SVE_contiguous_first_fault_load_scalar_plus_scalar6, NM("ldff1d"),
       // Following test gives ommited operands to xbyak_aarch64,
       // full operands to aarch64-linux-as. as can't handle with ommited
       // operands.
  ...
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar0, NM("ld2b"),
       OPS(SPECIFIC0, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar1, NM("ld3b"),
       OPS(SPECIFIC1, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar2, NM("ld4b"),
       OPS(SPECIFIC2, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar3, NM("ld2h"),
       OPS(SPECIFIC3, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar4, NM("ld3h"),
       OPS(SPECIFIC32, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar5, NM("ld4h"),
       OPS(SPECIFIC32_1, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar6, NM("ld2w"),
       OPS(SPECIFIC32_2, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar7, NM("ld3w"),
       OPS(SPECIFIC32_3, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar8, NM("ld4w"),
       OPS(SPECIFIC32_4, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar9, NM("ld2d"),
       OPS(SPECIFIC64, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_5, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar10, NM("ld3d"),
       OPS(SPECIFIC64_1, PG_Z, PTR_O, XNSP, XREG, SPECIFIC64_5, PTR_C));
  PUT1(SVE_load_multiple_structures_scalar_plus_scalar11, NM("ld4d"),
  ...
  PUT2(SVE_load_and_broadcast_quadword_scalar_plus_immediate0, NM("ld1rqb"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, SPECIFIC32_5, PTR_C));
  PUT2(SVE_load_and_broadcast_quadword_scalar_plus_immediate1, NM("ld1rqh"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC32_5, PTR_C));
  PUT2(SVE_load_and_broadcast_quadword_scalar_plus_immediate2, NM("ld1rqw"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32_5, PTR_C));
  PUT2(SVE_load_and_broadcast_quadword_scalar_plus_immediate3, NM("ld1rqd"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32_5, PTR_C));
  ...
  PUT8(SVE_contiguous_load_scalar_plus_immediate0, NM("ld1b"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT2(SVE_contiguous_load_scalar_plus_immediate1, NM("ld1sw", "ld1d"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT6(SVE_contiguous_load_scalar_plus_immediate2, NM("ld1h", "ld1sb"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT4(SVE_contiguous_load_scalar_plus_immediate3, NM("ld1sh", "ld1w"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  ...
  PUT8(SVE_contiguous_non_fault_load_scalar_plus_immediate0, NM("ldnf1b"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
  ...
  PUT2(SVE_contiguous_non_fault_load_scalar_plus_immediate1,
       NM("ldnf1sw", "ldnf1d"), OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT6(SVE_contiguous_non_fault_load_scalar_plus_immediate2,
       NM("ldnf1h", "ldnf1sb"), OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
  ...
  PUT4(SVE_contiguous_non_fault_load_scalar_plus_immediate3,
       NM("ldnf1sh", "ldnf1w"), OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  ...
  PUT1(SVE_contiguous_non_temporal_load_scalar_plus_scalar0, NM("ldnt1b"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_contiguous_non_temporal_load_scalar_plus_scalar1, NM("ldnt1h"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C));
  PUT1(SVE_contiguous_non_temporal_load_scalar_plus_scalar2, NM("ldnt1w"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, XREG, SPECIFIC2, PTR_C));
  PUT1(SVE_contiguous_non_temporal_load_scalar_plus_scalar3, NM("ldnt1d"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, XREG, SPECIFIC3, PTR_C));
  ...
  PUT2(SVE_contiguous_non_temporal_load_scalar_plus_immediate0, NM("ldnt1b"),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_B, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT2(SVE_contiguous_non_temporal_load_scalar_plus_immediate1, NM("ldnt1h"),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_H, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT2(SVE_contiguous_non_temporal_load_scalar_plus_immediate2, NM("ldnt1w"),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_S, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  PUT2(SVE_contiguous_non_temporal_load_scalar_plus_immediate3, NM("ldnt1d"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, PTR_C),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, SPECIFIC32, MULVL, PTR_C));
  ...
  PUT1(SVE_64_bit_gather_load_scalar_plus_unpacked_32_bit_unscaled_offsets0,
       NM("ldff1sb", "ld1b", "ldff1b", "ld1sb", "ld1sh", "ldff1sh", "ld1h",
          "ldff1h", "ld1sw", "ldff1sw", "ld1w", "ldff1w", "ld1d", "ldff1d"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, ZREG_D, XTW, PTR_C));
  ...
  PUT4(SVE_64_bit_gather_prefetch_vector_plus_immediate0, NM("prfb"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC32_3, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC32_3, PTR_C));
  PUT4(SVE_64_bit_gather_prefetch_vector_plus_immediate1, NM("prfh"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC32_4, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC32_4, PTR_C));
  PUT4(SVE_64_bit_gather_prefetch_vector_plus_immediate2, NM("prfw"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC32_5, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC32_5, PTR_C));
  PUT4(SVE_64_bit_gather_prefetch_vector_plus_immediate3, NM("prfd"),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_S, SPECIFIC64, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, PTR_C),
       OPS(PRFOP_SVE, PG, PTR_O, ZREG_D, SPECIFIC64, PTR_C));
  ...
  PUT2(SVE_64_bit_gather_load_vector_plus_immediate0,
       NM("ld1sb", "ldff1sb", "ld1b", "ldff1b"),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, IMM5BIT, PTR_C));

  PUT2(SVE_64_bit_gather_load_vector_plus_immediate1,
       NM("ld1sh", "ldff1sh", "ld1h", "ldff1h"),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, SPECIFIC32_4, PTR_C));

  PUT2(SVE_64_bit_gather_load_vector_plus_immediate2, NM("ld1sw", "ldff1sw"),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, SPECIFIC32_5, PTR_C));

  PUT2(SVE_64_bit_gather_load_vector_plus_immediate3, NM("ld1d", "ldff1d"),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG_Z, PTR_O, ZREG_D, SPECIFIC64, PTR_C));
  ...
  PUT1(SVE_64_bit_gather_load_scalar_plus_64_bit_unscaled_offset0,
       NM("ld1sb", "ldff1sb", "ld1b", "ldff1b", "ld1sh", "ldff1sh", "ld1h",
          "ldff1h", "ld1sw", "ldff1sw", "ld1w", "ldff1w", "ld1d", "ldff1d"),
       OPS(ZREG_D, PG_Z, PTR_O, XNSP, ZREG_D, PTR_C));
  ...
  PUT1(SVE_64_bit_gather_prefetch_scalar_plus_unpacked_32_bit_scaled_offsets0,
       NM("prfb"), OPS(PRFOP_SVE, PG, PTR_O, XNSP, ZREG_D, XTW, PTR_C));
  PUT1(SVE_64_bit_gather_prefetch_scalar_plus_unpacked_32_bit_scaled_offsets1,
       NM("prfh"), OPS(PRFOP_SVE, PG, PTR_O, XNSP, ZREG_D, SPECIFIC32, PTR_C));
  ...
  PUT1(SVE_64_bit_gather_prefetch_scalar_plus_64_bit_scaled_offsets0,
       NM("prfb"), OPS(PRFOP_SVE, PG, PTR_O, XNSP, ZREG_D, PTR_C));
  ...
  PUT4(SVE_contiguous_store_scalar_plus_scalar0, NM("st1b"),
  ...
  PUT3(SVE_contiguous_store_scalar_plus_scalar1, NM("st1h"),
  ...
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar0, NM("st2b"),
       OPS(SPECIFIC0, PG, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar1, NM("st3b"),
       OPS(SPECIFIC1, PG, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar2, NM("st4b"),
       OPS(SPECIFIC2, PG, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar3, NM("st2h"),
       OPS(SPECIFIC3, PG, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar4, NM("st3h"),
       OPS(SPECIFIC32, PG, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar5, NM("st4h"),
       OPS(SPECIFIC32_1, PG, PTR_O, XNSP, XREG, SPECIFIC64_3, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar6, NM("st2w"),
       OPS(SPECIFIC32_2, PG, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar7, NM("st3w"),
       OPS(SPECIFIC32_3, PG, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar8, NM("st4w"),
       OPS(SPECIFIC32_4, PG, PTR_O, XNSP, XREG, SPECIFIC64_4, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar9, NM("st2d"),
       OPS(SPECIFIC64, PG, PTR_O, XNSP, XREG, SPECIFIC64_5, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar10, NM("st3d"),
       OPS(SPECIFIC64_1, PG, PTR_O, XNSP, XREG, SPECIFIC64_5, PTR_C));
  PUT1(SVE_store_multiple_structures_scalar_plus_scalar11, NM("st4d"),
  ...
  PUT8(SVE_contiguous_store_scalar_plus_immediate0, NM("st1b"),
  ...
  PUT6(SVE_contiguous_store_scalar_plus_immediate1, NM("st1h"),
       OPS(BRA_O, ZREG_H, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_H, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  PUT4(SVE_contiguous_store_scalar_plus_immediate2, NM("st1w"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  PUT2(SVE_contiguous_store_scalar_plus_immediate3, NM("st1d"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  ...
  PUT1(SVE_contiguous_non_temporal_store_scalar_plus_scalar0, NM("stnt1b"),
       OPS(BRA_O, ZREG_B, BRA_C, PG, PTR_O, XNSP, XREG, PTR_C));
  PUT1(SVE_contiguous_non_temporal_store_scalar_plus_scalar1, NM("stnt1h"),
       OPS(BRA_O, ZREG_H, BRA_C, PG, PTR_O, XNSP, XREG, SPECIFIC0, PTR_C));
  PUT1(SVE_contiguous_non_temporal_store_scalar_plus_scalar2, NM("stnt1w"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, XREG, SPECIFIC1, PTR_C));
  PUT1(SVE_contiguous_non_temporal_store_scalar_plus_scalar3, NM("stnt1d"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, XREG, SPECIFIC2, PTR_C));
  ...
  PUT2(SVE_contiguous_non_temporal_store_scalar_plus_immeidate0, NM("stnt1b"),
       OPS(BRA_O, ZREG_B, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_B, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  PUT2(SVE_contiguous_non_temporal_store_scalar_plus_immeidate1, NM("stnt1h"),
       OPS(BRA_O, ZREG_H, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_H, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  PUT2(SVE_contiguous_non_temporal_store_scalar_plus_immeidate2, NM("stnt1w"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  PUT2(SVE_contiguous_non_temporal_store_scalar_plus_immeidate3, NM("stnt1d"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, SPECIFIC64_1, MULVL, PTR_C));
  ...
  PUT1(SVE_64_bit_scatter_store_scalar_plus_64_bit_scaled_offsets0, NM("st1h"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, ZREG_D, SPECIFIC3, PTR_C));
  PUT1(SVE_64_bit_scatter_store_scalar_plus_64_bit_scaled_offsets1, NM("st1w"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, ZREG_D, SPECIFIC4, PTR_C));
  PUT1(SVE_64_bit_scatter_store_scalar_plus_64_bit_scaled_offsets2, NM("st1d"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, XNSP, ZREG_D, SPECIFIC5, PTR_C));
  ...
  PUT2(SVE_64_bit_scatter_store_vector_plus_immediate0, NM("st1b"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, IMM5BIT, PTR_C));

  PUT2(SVE_64_bit_scatter_store_vector_plus_immediate1, NM("st1h"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, SPECIFIC32_1, PTR_C));

  PUT2(SVE_64_bit_scatter_store_vector_plus_immediate2, NM("st1w"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, SPECIFIC32_2, PTR_C));

  PUT2(SVE_64_bit_scatter_store_vector_plus_immediate3, NM("st1d"),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, PTR_C),
       OPS(BRA_O, ZREG_D, BRA_C, PG, PTR_O, ZREG_D, SPECIFIC32_3, PTR_C));
  ...
  PUT1(SVE_32_bit_scatter_store_scalar_plus_32_bit_scaled_offsets0, NM("st1h"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, XNSP, ZREG_S, SPECIFIC3, PTR_C));
  PUT1(SVE_32_bit_scatter_store_scalar_plus_32_bit_scaled_offsets1, NM("st1w"),
  ...
  PUT2(SVE_32_bit_scatter_store_vector_plus_immediate0, NM("st1b"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, ZREG_S, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, ZREG_S, IMM5BIT, PTR_C));
  PUT2(SVE_32_bit_scatter_store_vector_plus_immediate1, NM("st1h"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, ZREG_S, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, ZREG_S, SPECIFIC32_1, PTR_C));
  PUT2(SVE_32_bit_scatter_store_vector_plus_immediate2, NM("st1w"),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, ZREG_S, PTR_C),
       OPS(BRA_O, ZREG_S, BRA_C, PG, PTR_O, ZREG_S, SPECIFIC32_2, PTR_C));
  ...
  PUT2(SVE_store_predicate_register0, NM("str"),
       OPS(SPECIFIC32, PTR_O, XNSP, PTR_C),
       OPS(SPECIFIC32, PTR_O, XNSP, SPECIFIC32_4, MULVL, PTR_C));

  void putSVE_store_predicate_register() { putSVE_store_predicate_register0(); }
  /*** SVE store vector register */
  PUT2(SVE_store_vector_register0, NM("str"), OPS(ZREG, PTR_O, XNSP, PTR_C),
       OPS(ZREG, PTR_O, XNSP, SPECIFIC32_4, MULVL, PTR_C));

  void putSVE_store_vector_register() { putSVE_store_vector_register0(); }

  void putSVE_Memory32bitGatherandUnsizedContiguous() {
    std::vector<int> tmp = {127, -256, -128, -64, -32, -16, -8, -4, -2,  -1,
  ...
  void putSVE_MemoryContiguousLoad0() {
    ...
    */
    ...
    jtv_SPECIFIC4.push_back(
        " "); /** Space is required to distinguish isRequireComma function . */
    jtv_SPECIFIC5.push_back(
        " "); /** Space is required to distinguish isRequireComma function . */
    jtv_SPECIFIC6.push_back(
        " "); /** Space is required to distinguish isRequireComma function . */
  ...
  void putSVE_MemoryContiguousLoad1() {
    ...
    for (int i : tmp0) {
      ...
      tv_SPECIFIC1.push_back("{ " + tmpStr + ".b, " + tmpStr1 + ".b, " +
                             tmpStr2 + ".b }");
      jtv_SPECIFIC1.push_back(tmpStr + ".b");

      tv_SPECIFIC2.push_back("{ " + tmpStr + ".b, " + tmpStr1 + ".b, " +
                             tmpStr2 + ".b, " + tmpStr3 + ".b }");
      ...
      tv_SPECIFIC32.push_back("{ " + tmpStr + ".h, " + tmpStr1 + ".h, " +
                              tmpStr2 + ".h }");
      jtv_SPECIFIC32.push_back(tmpStr + ".h");

      tv_SPECIFIC32_1.push_back("{ " + tmpStr + ".h, " + tmpStr1 + ".h, " +
                                tmpStr2 + ".h, " + tmpStr3 + ".h }");
      ...
      tv_SPECIFIC32_3.push_back("{ " + tmpStr + ".s, " + tmpStr1 + ".s, " +
                                tmpStr2 + ".s }");
      jtv_SPECIFIC32_3.push_back(tmpStr + ".s");

      tv_SPECIFIC32_4.push_back("{ " + tmpStr + ".s, " + tmpStr1 + ".s, " +
                                tmpStr2 + ".s, " + tmpStr3 + ".s }");
      ...
      tv_SPECIFIC64_1.push_back("{ " + tmpStr + ".d, " + tmpStr1 + ".d, " +
                                tmpStr2 + ".d }");
      jtv_SPECIFIC64_1.push_back(tmpStr + ".d");

      tv_SPECIFIC64_2.push_back("{ " + tmpStr + ".d, " + tmpStr1 + ".d, " +
                                tmpStr2 + ".d, " + tmpStr3 + ".d }");
  ...
  void putSVE_MemoryStore0() {
    ...
    std::vector<int> tmp1 = {127, -256, -128, -64, -32, -16, -4, -2,  -1, 0,
                             1,   2,    4,    8,   16,  32,  64, 128, 255};
    std::vector<int> tmp2 = {7, -8, -4, -2, -1, 0, 1, 2, 4};
    std::vector<int> tmp3 = {15, 0, 1, 2, 4, 8, 16, 31};
    std::vector<int> tmp4 = {127, -256, -128, -64, -32, -16, -8, -4, -2,  -1,
                             0,   1,    2,    4,   8,   16,  32, 64, 128, 255};
    clearTvAndJtv();
