...
const uint64_t BITMASK32 =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 2048, 4095 } */
const uint64_t BITMASK64 =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 4096, 8191 } */
const uint64_t LSL_IMM =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
const uint64_t LSL32 = 1ULL
                       << flagBit++; /** Test vector is generated on the fly. */
const uint64_t LSL64 = 1ULL
                       << flagBit++; /** Test vector is generated on the fly. */
...
const uint64_t SPECIFIC64_3 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
const uint64_t SHIFT_AMOUNT32 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
const uint64_t SHIFT_AMOUNT64 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */

const uint64_t VREG_8B =
    1ULL << flagBit++; /** Test vector is { v0.8b, v1.8b, ..., v31.8b } */
const uint64_t VREG_16B =
    1ULL << flagBit++; /** Test vector is { v0.16b, v1.16b, ..., v31.16b } */
const uint64_t VREG_2H =
    1ULL << flagBit++; /** Test vector is { v0.2h, v1.2h, ..., v31.2h } */
const uint64_t VREG_4H =
    1ULL << flagBit++; /** Test vector is { v0.b, v1.b, ..., v31.b } */
const uint64_t VREG_8H =
    1ULL << flagBit++; /** Test vector is { v0.b, v1.b, ..., v31.b } */
const uint64_t VREG_2S =
    1ULL << flagBit++; /** Test vector is { v0.b, v1.b, ..., v31.b } */
const uint64_t VREG_4S =
    1ULL << flagBit++; /** Test vector is { v0.b, v1.b, ..., v31.b } */
const uint64_t VREG_1D =
    1ULL << flagBit++; /** Test vector is { v0.b, v1.b, ..., v31.b } */
const uint64_t VREG_2D =
    1ULL << flagBit++; /** Test vector is { v0.b, v1.b, ..., v31.b } */
const uint64_t VREG_1Q =
    1ULL << flagBit++; /** Test vector is { v0.1q, v1.1q, ..., v31.1q } */
...
class Test {
  ...
  std::vector<std::string> tv_VREG_8B = {"v7.8b", "v0.8b", "v1.8b",  "v2.8b",
                                         "v4.8b", "v8.8b", "v16.8b", "v31.8b"};
  std::vector<std::string> tv_VREG_16B = {"v7.16b",  "v0.16b", "v1.16b",
                                          "v2.16b",  "v4.16b", "v8.16b",
                                          "v16.16b", "v31.16b"};
  std::vector<std::string> tv_VREG_2H = {"v7.2h", "v0.2h", "v1.2h",  "v2.2h",
                                         "v4.2h", "v8.2h", "v16.2h", "v31.2h"};
  std::vector<std::string> tv_VREG_4H = {"v7.4h", "v0.4h", "v1.4h",  "v2.4h",
                                         "v4.4h", "v8.4h", "v16.4h", "v31.4h"};
  std::vector<std::string> tv_VREG_8H = {"v7.8h", "v0.8h", "v1.8h",  "v2.8h",
                                         "v4.8h", "v8.8h", "v16.8h", "v31.8h"};
  std::vector<std::string> tv_VREG_2S = {"v7.2s", "v0.2s", "v1.2s",  "v2.2s",
                                         "v4.2s", "v8.2s", "v16.2s", "v31.2s"};
  std::vector<std::string> tv_VREG_4S = {"v7.4s", "v0.4s", "v1.4s",  "v2.4s",
                                         "v4.4s", "v8.4s", "v16.4s", "v31.4s"};
  std::vector<std::string> tv_VREG_1D = {"v7.1d", "v0.1d", "v1.1d",  "v2.1d",
                                         "v4.1d", "v8.1d", "v16.1d", "v31.1d"};
  std::vector<std::string> tv_VREG_2D = {"v7.2d", "v0.2d", "v1.2d",  "v2.2d",
                                         "v4.2d", "v8.2d", "v16.2d", "v31.2d"};
  std::vector<std::string> tv_VREG_1Q = {"v7.1q", "v0.1q", "v1.1q",  "v2.1q",
                                         "v4.1q", "v8.1q", "v16.1q", "v31.1q"};

  std::vector<std::string> jtv_VREG_8B = {"v7.b8", "v0.b8", "v1.b8",  "v2.b8",
                                          "v4.b8", "v8.b8", "v16.b8", "v31.b8"};
  std::vector<std::string> jtv_VREG_16B = {"v7.b16",  "v0.b16", "v1.b16",
                                           "v2.b16",  "v4.b16", "v8.b16",
                                           "v16.b16", "v31.b16"};
  std::vector<std::string> jtv_VREG_2H = {"v7.h2", "v0.h2", "v1.h2",  "v2.h2",
                                          "v4.h2", "v8.h2", "v16.h2", "v31.h2"};
  std::vector<std::string> jtv_VREG_4H = {"v7.h4", "v0.h4", "v1.h4",  "v2.h4",
                                          "v4.h4", "v8.h4", "v16.h4", "v31.h4"};
  std::vector<std::string> jtv_VREG_8H = {"v7.h8", "v0.h8", "v1.h8",  "v2.h8",
                                          "v4.h8", "v8.h8", "v16.h8", "v31.h8"};
  std::vector<std::string> jtv_VREG_2S = {"v7.s2", "v0.s2", "v1.s2",  "v2.s2",
                                          "v4.s2", "v8.s2", "v16.s2", "v31.s2"};
  std::vector<std::string> jtv_VREG_4S = {"v7.s4", "v0.s4", "v1.s4",  "v2.s4",
                                          "v4.s4", "v8.s4", "v16.s4", "v31.s4"};
  std::vector<std::string> jtv_VREG_1D = {"v7.d1", "v0.d1", "v1.d1",  "v2.d1",
                                          "v4.d1", "v8.d1", "v16.d1", "v31.d1"};
  std::vector<std::string> jtv_VREG_2D = {"v7.d2", "v0.d2", "v1.d2",  "v2.d2",
                                          "v4.d2", "v8.d2", "v16.d2", "v31.d2"};
  std::vector<std::string> jtv_VREG_1Q = {"v7.q1", "v0.q1", "v1.q1",  "v2.q1",
                                          "v4.q1", "v8.q1", "v16.q1", "v31.q1"};
  ...
  std::vector<std::vector<std::string> *> tv_VectorsAs = {
      ...
      &tv_BITMASK32,    &tv_BITMASK64,      &tv_LSL_IMM,
      &tv_LSL32,        &tv_LSL64,          &tv_SPECIFIC32,
      &tv_SPECIFIC64,   &tv_SPECIFIC32_1,   &tv_SPECIFIC64_1,
      &tv_SPECIFIC32_2, &tv_SPECIFIC64_2,   &tv_SPECIFIC32_3,
      &tv_SPECIFIC64_3, &tv_SHIFT_AMOUNT32, &tv_SHIFT_AMOUNT64,
      &tv_VREG_8B,      &tv_VREG_16B,       &tv_VREG_2H,
      &tv_VREG_4H,      &tv_VREG_8H,        &tv_VREG_2S,
      &tv_VREG_4S,      &tv_VREG_1D,        &tv_VREG_2D,
      &tv_VREG_1Q,      &tv_VREG_8B_ELEM,   &tv_VREG_16B_ELEM,
      &tv_VREG_4H_ELEM, &tv_VREG_8H_ELEM,   &tv_VREG_2S_ELEM,
      &tv_VREG_4S_ELEM, &tv_VREG_1D_ELEM,   &tv_VREG_2D_ELEM};
  ...
  */
  ...
  void setShiftAmount() {
    std::vector<std::string> tmpPtn32 = {"0x15", "0", "1",  "2",
                                         "4",    "8", "16", "31"};
    std::vector<std::string> tmpPtn64 = {"0x2a", "0",  "1",  "2", "4",
                                         "8",    "16", "32", "63"};
...
public:
  ...
  */
  ...
  void declareVregElem(std::string datasize, int lanenum,
    ...
    for (std::string i : vreg) {
      std::cout << "VReg" + Type + "Elem " + i + datasize + Lanenum + "_" +
                       fixedIdx
                << "= " + i + "." + datasize + Lanenum + fixedIdxPar + ";"
                << std::endl;
    }
    ...
    for (auto itr = idx.begin() + 1; itr != idx.end(); ++itr) {
      std::string tmp = std::to_string(*itr);
      std::string tmpPar = "[" + tmp + "]";
      std::cout << "VReg" + Type + "Elem " + fixedIdx + datasize + Lanenum +
                       "_" + tmp
                << "= " + fixedIdx + "." + datasize + Lanenum + tmpPar + ";"
                << std::endl;
    }
  }
  ...
  /** C7.2.184 MOV (scalar) */
  /** Scalar */
  PUT4(DataProcSimd_Move0, NM("dup", "mov"), OPS(BREG, VREG_B_ELEM),
       OPS(HREG, VREG_H_ELEM), OPS(SREG, VREG_S_ELEM), OPS(DREG, VREG_D_ELEM));
  /** Vector */
  PUT7(DataProcSimd_Move1, NM("dup"), OPS(VREG_8B, VREG_B_ELEM),
       OPS(VREG_16B, VREG_B_ELEM), OPS(VREG_4H, VREG_H_ELEM),
       OPS(VREG_8H, VREG_H_ELEM), OPS(VREG_2S, VREG_S_ELEM),
       OPS(VREG_4S, VREG_S_ELEM), OPS(VREG_2D, VREG_D_ELEM));
  /** C7.2.33 DUP (general) */
  /** Advanced SIMD */
  PUT7(DataProcSimd_Move2, NM("dup"), OPS(VREG_8B, WREG), OPS(VREG_16B, WREG),
       OPS(VREG_4H, WREG), OPS(VREG_8H, WREG), OPS(VREG_2S, WREG),
       OPS(VREG_4S, WREG), OPS(VREG_2D, XREG));
  /** C7.2.160 INS (element) */
  /** C7.2.185 MOV (element) */
  /** Advanced SIMD */
  PUT3(DataProcSimd_Move3, NM("ins", "mov"), OPS(VREG_B_ELEM, VREG_B_ELEM),
       OPS(VREG_H_ELEM, VREG_H_ELEM), OPS(VREG_S_ELEM, VREG_S_ELEM));
  PUT1(DataProcSimd_Move4, NM("ins"), OPS(VREG_D_ELEM, VREG_D_ELEM));
  /** C7.2.161 INS (general) */
  /** C7.2.186 MOV (general) */
  /** Advanced SIMD */
  PUT4(DataProcSimd_Move5, NM("ins", "mov"), OPS(VREG_B_ELEM, WREG),
       OPS(VREG_H_ELEM, WREG), OPS(VREG_S_ELEM, WREG), OPS(VREG_D_ELEM, XREG));
  /** C7.2.188 MOV (to general) */
  /** 32-bit, 64-bit */
  PUT2(DataProcSimd_Move6, NM("mov"), OPS(WREG, VREG_S_ELEM),
       OPS(XREG, VREG_D_ELEM));
  /** C7.2.353 UMOV */
  /** 32-bit, 64-bit */
  PUT4(DataProcSimd_Move7, NM("umov"), OPS(WREG, VREG_B_ELEM),
       OPS(WREG, VREG_H_ELEM), OPS(WREG, VREG_S_ELEM), OPS(XREG, VREG_D_ELEM));
  /** C7.2.263 SMOV */
  /** 32-bit, 64-bit */
  PUT5(DataProcSimd_Move8, NM("smov"), OPS(WREG, VREG_B_ELEM),
       OPS(WREG, VREG_H_ELEM), OPS(XREG, VREG_B_ELEM), OPS(XREG, VREG_H_ELEM),
       OPS(XREG, VREG_S_ELEM));
  ...
  /** C7.2.2 ADD (vector) */
  /** Scalar */
  PUT1(DataProcSimd_Arithmetic0, NM("add"), OPS(DREG, DREG, DREG));
  /** Vector */
  PUT4(DataProcSimd_Arithmetic1, NM("add"), OPS(VREG_8B, VREG_8B, VREG_8B),
       OPS(VREG_16B, VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H, VREG_8H));
  PUT3(DataProcSimd_Arithmetic2, NM("add"), OPS(VREG_2S, VREG_2S, VREG_2S),
       OPS(VREG_4S, VREG_4S, VREG_4S), OPS(VREG_2D, VREG_2D, VREG_2D));
  /** C7.2.11 AND (vector) */
  /** Three register s of the smae type variant */
  PUT2(DataProcSimd_Arithmetic3, NM("and_"), OPS(VREG_8B, VREG_8B, VREG_8B),
       OPS(VREG_16B, VREG_16B, VREG_16B));
  ...
  /** C7.2.187 MOV (vector) */
  /** Three registers of the smae type variant */
  PUT2(DataProcSimd_Arithmetic5, NM("mov"), OPS(VREG_8B, VREG_8B),
  ...
  PUT8(DataProcSimd_Arithmetic6, NM("fabd", "fmulx", "frecps", "frsqrts"),
       OPS(HREG, HREG, HREG), OPS(SREG, SREG, SREG), OPS(DREG, DREG, DREG),
       OPS(VREG_8H, VREG_8H, VREG_8H), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_4S, VREG_4S, VREG_4S), OPS(VREG_2S, VREG_2S, VREG_2S),
       OPS(VREG_2D, VREG_2D, VREG_2D));
  /** C7.2.43 FADD (scalar) */
  /** C7.2.91 FDIV (scalar) */
  PUT3(DataProcSimd_Arithmetic7, NM("fadd", "fdiv"), OPS(HREG, HREG, HREG),
       OPS(SREG, SREG, SREG), OPS(DREG, DREG, DREG));
  /** C7.2.90 FDIV (vector) */
  ...
  PUT5(DataProcSimd_Arithmetic8,
       NM("fdiv", "fmaxp", "fmaxnm", "fmin", "fminnm", "fmla", "fmls", "fmul",
          "fsub"),
       OPS(VREG_8H, VREG_8H, VREG_8H), OPS(VREG_4H, VREG_4H, VREG_4H),
  ...
  PUT2(DataProcSimd_Arithmetic9, NM("fmlal", "fmlal", "fmlsl", "fmlsl2"),
  ...
  PUT6(DataProcSimd_Arithmetic10,
       NM("mla", "mls", "mul", "saba", "sabd", "shadd", "shsub", "smax", "smin",
          "srhadd", "uaba", "uabd", "uhadd", "uhsub", "umax", "umin", "urhadd"),
       OPS(VREG_8B, VREG_8B, VREG_8B), OPS(VREG_16B, VREG_16B, VREG_16B),
  ...
  PUT8(DataProcSimd_Arithmetic11,
       NM("sqadd", "sqrshl", "sqshl", "sqsub", "uqadd", "uqrshl", "uqshl",
          "uqsub"),
       OPS(BREG, BREG, BREG), OPS(HREG, HREG, HREG), OPS(SREG, SREG, SREG),
       OPS(DREG, DREG, DREG), OPS(VREG_8B, VREG_8B, VREG_8B),
       OPS(VREG_16B, VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H, VREG_8H));
  ...
  PUT6(DataProcSimd_Arithmetic13,
       NM("sqdmulh", "sqrdmlah", "sqrdmlsh", "sqrdmulh"), OPS(HREG, HREG, HREG),
       OPS(SREG, SREG, SREG), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S, VREG_2S),
  ...
  /** Scalar variant */
  /** Vector variant */
  PUT8(DataProcSimd_Arithmetic14, NM("srshl", "sshl", "sub", "urshl", "ushl"),
       OPS(DREG, DREG, DREG), OPS(VREG_8B, VREG_8B, VREG_8B),
       OPS(VREG_16B, VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S, VREG_2S),
       OPS(VREG_4S, VREG_4S, VREG_4S), OPS(VREG_2D, VREG_2D, VREG_2D));
  ...
  /** Scalar variant */
  /** Vector variant */
  PUT8(DataProcSimd_Compare1, NM("cmeq", "cmge", "cmgt", "cmle", "cmlt"),
       OPS(DREG, DREG, SPECIFIC64), OPS(VREG_8B, VREG_8B, SPECIFIC64),
       OPS(VREG_16B, VREG_16B, SPECIFIC64), OPS(VREG_4H, VREG_4H, SPECIFIC64),
       OPS(VREG_8H, VREG_8H, SPECIFIC64), OPS(VREG_2S, VREG_2S, SPECIFIC64),
       OPS(VREG_4S, VREG_4S, SPECIFIC64), OPS(VREG_2D, VREG_2D, SPECIFIC64));
  ...
  /** Vector half precision */
  /** Vector single-precision and double-precision */
  PUT8(DataProcSimd_Compare2, NM("fcmeq", "fcmge", "fcmgt", "facge", "facgt"),
       OPS(HREG, HREG, HREG), OPS(SREG, SREG, SREG), OPS(DREG, DREG, DREG),
       OPS(VREG_8H, VREG_8H, VREG_8H), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_4S, VREG_4S, VREG_4S), OPS(VREG_2S, VREG_2S, VREG_2S),
       OPS(VREG_2D, VREG_2D, VREG_2D));
  ...
  /** C7.2.57 FCMLE (zero) */
  /** C7.2.58 FCMLT (zero) */
  PUT8(DataProcSimd_Compare3, NM("fcmeq", "fcmge", "fcmgt", "fcmle", "fcmlt"),
       OPS(HREG, HREG, SPECIFIC64), OPS(SREG, SREG, SPECIFIC64),
       OPS(DREG, DREG, SPECIFIC64), OPS(VREG_8H, VREG_8H, SPECIFIC64),
       OPS(VREG_4H, VREG_4H, SPECIFIC64), OPS(VREG_4S, VREG_4S, SPECIFIC64),
       OPS(VREG_2S, VREG_2S, SPECIFIC64), OPS(VREG_2D, VREG_2D, SPECIFIC64));
  ...
  PUT3(DataProcSimd_WideningAndNarrowingArithmetic0,
       NM("addhn", "raddhn", "rsubhn", "subhn"), OPS(VREG_8B, VREG_8H, VREG_8H),
       OPS(VREG_4H, VREG_4S, VREG_4S), OPS(VREG_2S, VREG_2D, VREG_2D));
  ...
  /** Three registers, not all the same type variant */
  PUT2(DataProcSimd_WideningAndNarrowingArithmetic2, NM("pmull"),
       OPS(VREG_8H, VREG_8B, VREG_8B), OPS(VREG_1Q, VREG_1D, VREG_1D));
  PUT2(DataProcSimd_WideningAndNarrowingArithmetic3, NM("pmull2"),
  ...
  PUT3(DataProcSimd_WideningAndNarrowingArithmetic6, NM("saddw"),
       OPS(VREG_8H, VREG_8H, VREG_8B), OPS(VREG_4S, VREG_4S, VREG_4H),
       OPS(VREG_2D, VREG_2D, VREG_2S));
  PUT3(DataProcSimd_WideningAndNarrowingArithmetic7, NM("saddw2"),
  ...
  PUT4(DataProcSimd_WideningAndNarrowingArithmetic8,
       NM("sqdmlal", "sqdmlsl", "sqdmull"), OPS(SREG, HREG, HREG),
       OPS(DREG, SREG, SREG), OPS(VREG_4S, VREG_4H, VREG_4H),
       OPS(VREG_2D, VREG_2S, VREG_2S));
  PUT2(DataProcSimd_WideningAndNarrowingArithmetic9,
       NM("sqdmlal2", "sqdmlsl2", "sqdmull2"), OPS(VREG_4S, VREG_8H, VREG_8H),
       OPS(VREG_2D, VREG_4S, VREG_4S));
  ...
  PUT3(DataProcSimd_WideningAndNarrowingArithmetic10,
       NM("ssubw", "uaddw", "usubw"), OPS(VREG_8H, VREG_8H, VREG_8B),
       OPS(VREG_4S, VREG_4S, VREG_4H), OPS(VREG_2D, VREG_2D, VREG_2S));
  PUT3(DataProcSimd_WideningAndNarrowingArithmetic11,
       NM("ssubw2", "uaddw2", "usubw2"), OPS(VREG_8H, VREG_8H, VREG_16B),
       OPS(VREG_4S, VREG_4S, VREG_8H), OPS(VREG_2D, VREG_2D, VREG_4S));
  ...
  /** Scalar variant */
  /** Vector variant */
  PUT8(DataProcSimd_UnaryArithmetic0, NM("abs", "neg"), OPS(DREG, DREG),
       OPS(VREG_8B, VREG_8B), OPS(VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S),
       OPS(VREG_2D, VREG_2D));
  /** C7.2.18 CLS (vector) */
  /** C7.2.19 CLZ (vector) */
  /** C7.2.06 REV64 */
  /** Vector variant */
  PUT6(DataProcSimd_UnaryArithmetic1, NM("cls", "clz", "rev64"),
       OPS(VREG_8B, VREG_8B), OPS(VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S));
  /** C7.2.31 CNT */
  /** C7.2.192 MVN */
  ...
  /** Vector variant */
  PUT2(DataProcSimd_UnaryArithmetic2, NM("cnt", "mvn", "not_", "rbit", "rev16"),
  ...
  PUT5(DataProcSimd_UnaryArithmetic3,
       NM("fabs", "fneg", "frinti", "frintm", "frintn", "frintp", "frintx",
          "frintz", "fsqrt"),
       OPS(VREG_4H, VREG_4H), OPS(VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S),
       OPS(VREG_4S, VREG_4S), OPS(VREG_2D, VREG_2D));
  /** C7.2.67 FCVTL, FCVTL2 */
  /** Vector single-precison and doiuble-precision variant */
  PUT2(DataProcSimd_UnaryArithmetic4, NM("fcvtl"), OPS(VREG_4S, VREG_4H),
       OPS(VREG_2D, VREG_2S));
  PUT2(DataProcSimd_UnaryArithmetic5, NM("fcvtl2"), OPS(VREG_4S, VREG_8H),
       OPS(VREG_2D, VREG_4S));
  /** C7.2.72 FCVTN, FCVTN2 */
  /** Vector single-precison and doiuble-precision variant */
  PUT2(DataProcSimd_UnaryArithmetic6, NM("fcvtn"), OPS(VREG_4H, VREG_4S),
       OPS(VREG_2S, VREG_2D));
  PUT2(DataProcSimd_UnaryArithmetic7, NM("fcvtn2"), OPS(VREG_8H, VREG_4S),
       OPS(VREG_4S, VREG_2D));
  /** C7.2.81 FCVTXN, FCVTXN2 */
  /** Scalar variant */
  /** Vector variant */
  PUT2(DataProcSimd_UnaryArithmetic8, NM("fcvtxn"), OPS(SREG, DREG),
       OPS(VREG_2S, VREG_2D));
  PUT1(DataProcSimd_UnaryArithmetic9, NM("fcvtxn2"), OPS(VREG_4S, VREG_2D));
  /** C7.2.137 FRECPE */
  /** C7.2.154 FRSQRTE */
  /** Scalar half precision variant */
  /** Scalar single-precision and double-precision */
  /** Vector half precision */
  /** Vector single-precision and double-precision */
  PUT8(DataProcSimd_UnaryArithmetic10, NM("frecpe", "frsqrte"), OPS(HREG, HREG),
       OPS(SREG, SREG), OPS(DREG, DREG), OPS(VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S),
       OPS(VREG_2D, VREG_2D));
  /** C7.2.139 FRECPX */
  ...
  /** Single-precision and double-precision */
  PUT3(DataProcSimd_UnaryArithmetic11, NM("frecpx", "frinta"), OPS(HREG, HREG),
       OPS(SREG, SREG), OPS(DREG, DREG));
  /** C7.2.205 REV32 (vector) */
  PUT4(DataProcSimd_UnaryArithmetic12, NM("rev32"), OPS(VREG_8B, VREG_8B),
       OPS(VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H), OPS(VREG_8H, VREG_8H));
  /** C7.2.213 SADALP */
  /** C7.2.215 SADDLP */
  /** C7.2.330 UADALP */
  /** C7.2.332 UADDLP */
  ...
  PUT6(DataProcSimd_UnaryArithmetic13,
       NM("sadalp", "saddlp", "uadalp", "uaddlp"), OPS(VREG_4H, VREG_8B),
       OPS(VREG_8H, VREG_16B), OPS(VREG_2S, VREG_4H), OPS(VREG_4S, VREG_8H),
       OPS(VREG_1D, VREG_2S), OPS(VREG_2D, VREG_4S));
  /** C7.2.321 SXTL, SXTL2 */
  PUT3(DataProcSimd_UnaryArithmetic14, NM("sxtl"), OPS(VREG_8H, VREG_8B),
       OPS(VREG_4S, VREG_4H), OPS(VREG_2D, VREG_2S));
  PUT3(DataProcSimd_UnaryArithmetic15, NM("sxtl2"), OPS(VREG_8H, VREG_16B),
  ...
  /** Scalar variant */
  /** Vector variant */
  PUT8(DataProcSimd_UnaryArithmetic16, NM("sqabs", "sqneg", "suqadd", "usqadd"),
       OPS(BREG, BREG), OPS(HREG, HREG), OPS(SREG, SREG), OPS(DREG, DREG),
       OPS(VREG_8B, VREG_8B), OPS(VREG_16B, VREG_16B), OPS(VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H));
  PUT3(DataProcSimd_UnaryArithmetic17, NM("sqabs", "sqneg", "suqadd", "usqadd"),
  ...
  /** Scalar variant */
  /** Vecotr variant */
  PUT6(DataProcSimd_UnaryArithmetic18, NM("sqxtn", "sqxtun", "uqxtn"),
       OPS(BREG, HREG), OPS(HREG, SREG), OPS(SREG, DREG), OPS(VREG_8B, VREG_8H),
       OPS(VREG_4H, VREG_4S), OPS(VREG_2S, VREG_2D));
  PUT3(DataProcSimd_UnaryArithmetic19, NM("sqxtn2", "sqxtun2", "uqxtn2"),
       OPS(VREG_16B, VREG_8H), OPS(VREG_8H, VREG_4S), OPS(VREG_4S, VREG_2D));
  /** C7.2.364 URECPE */
  /** C7.2.368 URSQRTE */
  /** Vector variant */
  PUT2(DataProcSimd_UnaryArithmetic20, NM("urecpe", "ursqrte"),
       OPS(VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S));
  /** C7.2.377 UXTL, UXTL2 */
  /** Vector variant */
  PUT3(DataProcSimd_UnaryArithmetic21, NM("uxtl"), OPS(VREG_8H, VREG_8B),
       OPS(VREG_4S, VREG_4H), OPS(VREG_2D, VREG_2S));
  PUT3(DataProcSimd_UnaryArithmetic22, NM("uxtl2"), OPS(VREG_8H, VREG_16B),
       OPS(VREG_4S, VREG_8H), OPS(VREG_2D, VREG_4S));
  /** C7.2.381 XTN, XTN2 */
  /** Vector variant */
  PUT3(DataProcSimd_UnaryArithmetic23, NM("xtn"), OPS(VREG_8B, VREG_8H),
       OPS(VREG_4H, VREG_4S), OPS(VREG_2S, VREG_2D));
  PUT3(DataProcSimd_UnaryArithmetic24, NM("xtn2"), OPS(VREG_16B, VREG_8H),
  ...
  PUT8(DataProcSimd_ByElementArithmetic0, NM("fmla", "fmls", "fmul", "fmulx"),
       // Scalar, half-precision variant
  ...
  PUT2(DataProcSimd_ByElementArithmetic1,
       ...
       OPS(VREG_2S, VREG_2H, SPECIFIC32), OPS(VREG_4S, VREG_4H, SPECIFIC32));
  /** C7.2.180 MLA (by element) */
  /** C7.2.182 MLS (by element) */
  /** C7.2.190 MUL (by element) */
  /** Vecotr variant */
  PUT4(DataProcSimd_ByElementArithmetic2, NM("mla", "mls", "mul"),
       OPS(VREG_4H, VREG_4H, SPECIFIC32), OPS(VREG_8H, VREG_8H, SPECIFIC32),
       OPS(VREG_2S, VREG_2S, VREG_S_ELEM), OPS(VREG_4S, VREG_4S, VREG_S_ELEM));
  ...
  /** Vecotr variant */
  PUT2(DataProcSimd_ByElementArithmetic3, NM("smlal", "smull"),
       OPS(VREG_4S, VREG_4H, SPECIFIC32), OPS(VREG_2D, VREG_2S, VREG_S_ELEM));
  PUT2(DataProcSimd_ByElementArithmetic4, NM("smlal2", "smull2"),
       OPS(VREG_4S, VREG_8H, SPECIFIC32), OPS(VREG_2D, VREG_4S, VREG_S_ELEM));
  /** C7.2.268 SQDMLAL, SQDMLAL2 (by element) */
  /** C7.2.270 SQDMLSL, SQDMLSL2 (by element) */
  /** C7.2.274 SQDMULL, SQDMULL2 (by element) */
  /** Scara varaint */
  /** Vector variant */
  PUT4(DataProcSimd_ByElementArithmetic5, NM("sqdmlal", "sqdmlsl", "sqdmull"),
  ...
  /** Scalar variant */
  /** Vector variatn */
  PUT6(DataProcSimd_ByElementArithmetic7, NM("sqdmulh", "sqrdmlsh", "sqrdmulh"),
  ...
  /** Scalar variant */
  /** Vector variant */
  PUT6(DataProcSimd_ByElementArithmetic8, NM("sqrdmlsh"), OPS(HREG, HREG, HREG),
       OPS(SREG, SREG, SREG), OPS(VREG_4H, VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S, VREG_2S),
       OPS(VREG_4S, VREG_4S, VREG_4S));
  ...
  /** Vecotr variant */
  PUT2(DataProcSimd_ByElementArithmetic9, NM("umlal", "umlsl", "umull"),
       OPS(VREG_4S, VREG_4H, SPECIFIC32), OPS(VREG_2D, VREG_2S, VREG_S_ELEM));
  PUT2(DataProcSimd_ByElementArithmetic10, NM("umlal2", "umlsl2", "umull2"),
       OPS(VREG_4S, VREG_8H, SPECIFIC32), OPS(VREG_2D, VREG_4S, VREG_S_ELEM));

  void putDataProcSimd_ByElementArithmetic() {
    std::vector<std::string> vreg = {"v7", "v0", "v1", "v2", "v4", "v8", "v15"};
    std::vector<std::string> vreg_elem = {"v6.8h[7]",  "v0.8h[7]",  "v1.8h[7]",
                                          "v2.8h[7]",  "v4.8h[7]",  "v8.8h[7]",
                                          "v15.8h[7]", "v15.8h[0]", "v15.8h[1]",
                                          "v15.8h[2]", "v15.8h[4]"};
    std::vector<std::string> jvreg_elem = {
        "v6.h8[7]",  "v0.h8[7]",  "v1.h8[7]",  "v2.h8[7]",
        "v4.h8[7]",  "v8.h8[7]",  "v15.h8[7]", "v15.h8[0]",
        "v15.h8[1]", "v15.h8[2]", "v15.h8[4]"};
  ...
  PUT2(DataProcSimd_Permute0, NM("ext"),
       OPS(VREG_8B, VREG_8B, VREG_8B, IMM3BIT),
       OPS(VREG_16B, VREG_16B, VREG_16B, IMM4BIT));
  /** C7.2.324 TRN1 */
  /** C7.2.325 TRN2 */
  /** C7.2.378 UZP1 */
  /** C7.2.379 UZP2 */
  ...
  /** 16-bit variant */
  /** 32-bit variant */
  PUT8(DataProcSimd_Immediate0, NM("bic"), OPS(VREG_4H, IMM8BIT),
       OPS(VREG_4H, IMM8BIT, SHIFT_AMOUNT32), OPS(VREG_8H, IMM8BIT),
       OPS(VREG_8H, IMM8BIT, SHIFT_AMOUNT32), OPS(VREG_2S, IMM8BIT),
       OPS(VREG_2S, IMM8BIT, SHIFT_AMOUNT64), OPS(VREG_4S, IMM8BIT),
       OPS(VREG_4S, IMM8BIT, SHIFT_AMOUNT64));
  /** C7.2.122 FMOV (vector, immediate) */
  /** Half-precison variatn */
  /** Single-precision variant */
  /** Double-precisoin variant */
  PUT7(DataProcSimd_Immediate1, NM("fmov"), OPS(VREG_4H, FLOAT8BIT),
       OPS(VREG_8H, FLOAT8BIT), OPS(VREG_2S, FLOAT8BIT),
       OPS(VREG_2S, FLOAT8BIT), OPS(VREG_4S, FLOAT8BIT),
       OPS(VREG_4S, FLOAT8BIT), OPS(VREG_2D, FLOAT8BIT));
  /** C7.2.189 MOVI */
  PUT8(DataProcSimd_Immediate2, NM("movi"),
       // 8-bit variant
  ...
  PUT8(DataProcSimd_Immediate3, NM("movi"),
       ...
       OPS(VREG_2S, IMM8BIT, SHIFT_AMOUNT32),
       OPS(VREG_4S, IMM8BIT, SHIFT_AMOUNT32),
       // 64-bit scalar variatn
       // 64-bit vector variant
       OPS(DREG, LSL32), OPS(VREG_2D, LSL32));
  /** C7.2.193 MVNI */
  PUT8(DataProcSimd_Immediate4, NM("mvni"),
       // 16-bit shifted immediate variant
       OPS(VREG_4H, IMM8BIT), OPS(VREG_4H, IMM8BIT, SHIFT_AMOUNT32),
       OPS(VREG_8H, IMM8BIT), OPS(VREG_8H, IMM8BIT, SHIFT_AMOUNT32),
  ...
  void putDataProcSimd_Immediate() {
    ...
    std::vector<std::string> tmp8bit = {"0xff",
                                        "0xff00",
                                        "0x00ff0000",
                                        "0xff000000",
                                        "0x00ff00000000",
  ...
  /** C7.2.241 SHRN, SHRN2 */
  /** Vector variant */
  PUT3(DataProcSimd_ShiftImmediate0, NM("rshrn", "shrn"),
       OPS(VREG_8B, VREG_8H, IMM3BIT_N), OPS(VREG_4H, VREG_4S, IMM4BIT_N),
       OPS(VREG_2S, VREG_2D, IMM5BIT_N));
  PUT3(DataProcSimd_ShiftImmediate1, NM("rshrn2", "shrn2"),
       OPS(VREG_16B, VREG_8H, IMM3BIT_N), OPS(VREG_8H, VREG_4S, IMM4BIT_N),
       OPS(VREG_4S, VREG_2D, IMM5BIT_N));
  /** C7.2.239 SHL */
  /** C7.2.243 SLI */
  /** Scalar variant */
  /** Vector variant */
  PUT8(DataProcSimd_ShiftImmediate2, NM("shl", "sli"), OPS(DREG, DREG, IMM6BIT),
  ...
  /** C7.2.377 UXTL, UXTL2 */
  /** Vector variant */
  PUT3(DataProcSimd_ShiftImmediate3, NM("shll"),
       OPS(VREG_8H, VREG_8B, SPECIFIC32), OPS(VREG_4S, VREG_4H, SPECIFIC32_1),
       OPS(VREG_2D, VREG_2S, SPECIFIC32_2));
  PUT3(DataProcSimd_ShiftImmediate4, NM("shll2"),
       OPS(VREG_8H, VREG_16B, SPECIFIC32), OPS(VREG_4S, VREG_8H, SPECIFIC32_1),
       OPS(VREG_2D, VREG_4S, SPECIFIC32_2));
  /** C7.2.377 UXTL, UXTL2 */
  /** Vector variant */
  PUT3(DataProcSimd_ShiftImmediate5, NM("uxtl"), OPS(VREG_8H, VREG_8B),
       OPS(VREG_4S, VREG_4H), OPS(VREG_2D, VREG_2S));
  PUT3(DataProcSimd_ShiftImmediate6, NM("uxtl2"), OPS(VREG_8H, VREG_16B),
       OPS(VREG_4S, VREG_8H), OPS(VREG_2D, VREG_4S));
  ...
  PUT6(DataProcSimd_ShiftImmediate7,
       ...
       OPS(BREG, HREG, IMM3BIT_N), OPS(HREG, SREG, IMM4BIT_N),
       OPS(SREG, DREG, IMM5BIT_N), OPS(VREG_8B, VREG_8H, IMM3BIT_N),
       OPS(VREG_4H, VREG_4S, IMM4BIT_N), OPS(VREG_2S, VREG_2D, IMM5BIT_N));
  PUT3(DataProcSimd_ShiftImmediate8,
       NM("sqrshrn2", "sqrshrun2", "sqshrn2", "sqshrun2", "uqrshrn2",
          "uqshrn2"),
       OPS(VREG_16B, VREG_8H, IMM3BIT_N), OPS(VREG_8H, VREG_4S, IMM4BIT_N),
       OPS(VREG_4S, VREG_2D, IMM5BIT_N));
  ...
  /** Scalar variant */
  /** Vector variant */
  PUT8(DataProcSimd_ShiftImmediate9, NM("sqshl", "sqshlu", "uqshl"),
       OPS(BREG, BREG, IMM3BIT), OPS(HREG, HREG, IMM4BIT),
       OPS(SREG, SREG, IMM5BIT), OPS(DREG, DREG, IMM6BIT),
       OPS(VREG_8B, VREG_8B, IMM3BIT), OPS(VREG_16B, VREG_16B, IMM3BIT),
       OPS(VREG_4H, VREG_4H, IMM4BIT), OPS(VREG_8H, VREG_8H, IMM4BIT));
  PUT3(DataProcSimd_ShiftImmediate10, NM("sqshl", "sqshlu", "uqshl"),
  ...
  PUT8(DataProcSimd_ShiftImmediate11,
       ...
       OPS(DREG, DREG, IMM6BIT_N), OPS(VREG_8B, VREG_8B, IMM3BIT_N),
       OPS(VREG_16B, VREG_16B, IMM3BIT_N), OPS(VREG_4H, VREG_4H, IMM4BIT_N),
       OPS(VREG_8H, VREG_8H, IMM4BIT_N), OPS(VREG_2S, VREG_2S, IMM5BIT_N),
       OPS(VREG_4S, VREG_4S, IMM5BIT_N), OPS(VREG_2D, VREG_2D, IMM6BIT_N));
  /** C7.2.300 SSHLL, SSHLL2 */
  /** C7.2.371 USHLL, USHLL2 */
  /** Vector variant */
  PUT3(DataProcSimd_ShiftImmediate12, NM("sshll", "ushll"),
       OPS(VREG_8H, VREG_8B, IMM3BIT), OPS(VREG_4S, VREG_4H, IMM4BIT),
       OPS(VREG_2D, VREG_2S, IMM5BIT));
  PUT3(DataProcSimd_ShiftImmediate13, NM("sshll2", "ushll2"),
       OPS(VREG_8H, VREG_16B, IMM3BIT), OPS(VREG_4S, VREG_8H, IMM4BIT),
       OPS(VREG_2D, VREG_4S, IMM5BIT));
  /** C7.2.321 SXTL, SXTL2 */
  PUT3(DataProcSimd_ShiftImmediate14, NM("sxtl"), OPS(VREG_8H, VREG_8B),
       OPS(VREG_4S, VREG_4H), OPS(VREG_2D, VREG_2S));
  PUT3(DataProcSimd_ShiftImmediate15, NM("sxtl2"), OPS(VREG_8H, VREG_16B),
       OPS(VREG_4S, VREG_8H), OPS(VREG_2D, VREG_4S));
  ...
  PUT8(DataProcSimd_FloatingPointAndIntergerConversion0,
       NM("fcvtas", "fcvtau", "fcvtms", "fcvtmu", "fcvtns", "fcvtnu", "fcvtps",
          "fcvtpu", "fcvtzs", "fcvtzu", "scvtf", "ucvtf"),
       OPS(HREG, HREG), OPS(SREG, SREG), OPS(DREG, DREG), OPS(VREG_4H, VREG_4H),
       OPS(VREG_8H, VREG_8H), OPS(VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S),
       OPS(VREG_2D, VREG_2D));
  ...
  PUT8(DataProcSimd_FloatingPointAndIntergerConversion1,
       NM("fcvtzs", "fcvtzu", "scvtf", "ucvtf"), OPS(HREG, HREG, IMM4BIT_N),
       OPS(SREG, SREG, IMM5BIT_N), OPS(DREG, DREG, IMM6BIT_N),
  ...
  /** C7.2.6 ADDV */
  /** Advanced SIMD variant */
  PUT5(DataProcSimd_ReduceAcrossVectorLanes0, NM("addv"), OPS(BREG, VREG_8B),
       OPS(BREG, VREG_16B), OPS(HREG, VREG_4H), OPS(HREG, VREG_8H),
       OPS(SREG, VREG_4S));
  /** C7.2.100 FMAXNMV */
  /** C7.2.103 FMAXV */
  /** C7.2.110 FMINNMV */
  ...
  /** C7.2.333 UADDLV */
  /** Advanced SIMD variant */
  PUT5(DataProcSimd_ReduceAcrossVectorLanes2, NM("saddlv", "uaddlv"),
       OPS(HREG, VREG_8B), OPS(HREG, VREG_16B), OPS(SREG, VREG_4H),
       OPS(SREG, VREG_8H), OPS(DREG, VREG_4S));
  /** C7.2.255 SMAXV */
  /** C7.2.258 SMINV */
  /** C7.2.345 UMAXV */
  /** C7.2.348 UMINV */
  ...
  PUT5(DataProcSimd_ReduceAcrossVectorLanes3,
       NM("smaxv", "sminv", "umaxv", "uminv"), OPS(BREG, VREG_8B),
       OPS(BREG, VREG_16B), OPS(HREG, VREG_4H), OPS(HREG, VREG_8H),
       OPS(SREG, VREG_4S));
  ...
  PUT7(DataProcSimd_PairwiseArithmetic0, NM("addp"),
       OPS(VREG_8B, VREG_8B, VREG_8B), OPS(VREG_16B, VREG_16B, VREG_16B),
       OPS(VREG_4H, VREG_4H, VREG_4H), OPS(VREG_8H, VREG_8H, VREG_8H),
       OPS(VREG_2S, VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S, VREG_4S),
       OPS(VREG_2D, VREG_2D, VREG_2D));
  /** C7.2.4 ADDP (scalar) */
  PUT1(DataProcSimd_PairwiseArithmetic1, NM("addp"), OPS(DREG, VREG_2D));
  ...
  PUT3(DataProcSimd_PairwiseArithmetic3,
       NM("faddp", "fmaxnmp", "fmaxp", "fminnmp"), OPS(HREG, VREG_2H),
       OPS(SREG, VREG_2S), OPS(DREG, VREG_2D));
  /** C7.2.254 SMAXP */
  /** C7.2.257 SMINP */
  /** C7.2.344 UMAXP */
  /** C7.2.347 UMINP */
  /** Three registers of the same type variant */
  PUT6(DataProcSimd_PairwiseArithmetic4, NM("smaxp", "sminp", "umaxp", "uminp"),
       OPS(VREG_8B, VREG_8B, VREG_8B), OPS(VREG_16B, VREG_16B, VREG_16B),
       OPS(VREG_4H, VREG_4H, VREG_4H), OPS(VREG_8H, VREG_8H, VREG_8H),
       OPS(VREG_2S, VREG_2S, VREG_2S), OPS(VREG_4S, VREG_4S, VREG_4S));
  ...
  PUT2(DataProcSimd_TableLookup0, NM("tbl", "tbx"),
  ...
  void putDataProcSimd_TableLookup() {
    ...
    /** Two register */
    for (int i : tmpReg) {
      tv_SPECIFIC32.push_back("{ v" + std::to_string(i) + ".16b, v" +
                              std::to_string((i + 1) % 32) + ".16b }");
    ...
    for (int i : tmpReg) {
      tv_SPECIFIC32.push_back("{ v" + std::to_string(i) + ".16b, v" +
                              std::to_string((i + 1) % 32) + ".16b, v" +
                              std::to_string((i + 2) % 32) + ".16b }");
    ...
    for (int i : tmpReg) {
      tv_SPECIFIC32.push_back("{ v" + std::to_string(i) + ".16b, v" +
                              std::to_string((i + 1) % 32) + ".16b, v" +
                              std::to_string((i + 2) % 32) + ".16b, v" +
                              std::to_string((i + 3) % 32) + ".16b }");
  ...
  /** C7.2.46 FCADD */
  /* Three registers of the same type variant */
  PUT5(DataProcSimd_ComplexNumberArithmetic0, NM("fcadd"),
       OPS(VREG_4H, VREG_4H, VREG_4H, SPECIFIC32),
       OPS(VREG_8H, VREG_8H, VREG_8H, SPECIFIC32),
       OPS(VREG_2S, VREG_2S, VREG_2S, SPECIFIC32),
       OPS(VREG_4S, VREG_4S, VREG_4S, SPECIFIC32),
       OPS(VREG_2D, VREG_2D, VREG_2D, SPECIFIC32));
  /** C7.2.56 FCMLA */
  /* Three registers of the smae type variant */
  PUT5(DataProcSimd_ComplexNumberArithmetic1, NM("fcmla"),
       OPS(VREG_4H, VREG_4H, VREG_4H, SPECIFIC64),
       OPS(VREG_8H, VREG_8H, VREG_8H, SPECIFIC64),
       OPS(VREG_2S, VREG_2S, VREG_2S, SPECIFIC64),
       OPS(VREG_4S, VREG_4S, VREG_4S, SPECIFIC64),
       OPS(VREG_2D, VREG_2D, VREG_2D, SPECIFIC64));
  /** C7.2.55 FCMLA (by element) */
  PUT3(DataProcSimd_ComplexNumberArithmetic2, NM("fcmla"),
       OPS(VREG_4H, VREG_4H, SPECIFIC32_1, SPECIFIC64),
       OPS(VREG_8H, VREG_8H, SPECIFIC32_1, SPECIFIC64),
  ...
  void putDataProcSimd_ComplexNumberArithmetic() {
    ...
    /** FCMLA <Vd>.<T>, <Vn>.<T>, <Vm>.<Ts>[<index>], #<rotate>
        <index> Is the element index, encoded in the "size:H:L" field. It can
       have the following values: H:L when size = 01 H when size = 10 */
    //    std::vector<std::string> tmpReg = { "v15", "v0", "v1", "v2", "v4",
    //    "v8", "v16", "v31" };
  ...
  PUT1(DataProcSimd_CryptographicExtension0,
       NM("aesd", "aese", "aesimc", "aesmc"), OPS(VREG_16B, VREG_16B));
  /** C7.2.200 PMULL, PMULL2 is already tested. */
  /** C7.2.224 SHA1C */
  /** C7.2.226 SHA1M */
  /** C7.2.227 SHA1P */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension1, NM("sha1c", "sha1m", "sha1p"),
       OPS(QREG, SREG, VREG_4S));
  /** C7.2.225 SHA1H */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension2, NM("sha1h"), OPS(SREG, SREG));
  /** C7.2.228 SHA1SU0 */
  /** C7.2.233 SHA256SU1 */
  /** C7.2.244 SM3PARTW1 */
  /** C7.2.245 SM3PARTW2 */
  ...
  /** C7.2.232 SHA256SU0 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension4, NM("sha1su1", "sha256su0"),
       OPS(VREG_4S, VREG_4S));
  /** C7.2.231 SHA256H */
  /** C7.2.230 SHA256H2 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension5, NM("sha256h", "sha256h2"),
       OPS(QREG, QREG, VREG_4S));
  /** C7.2.234 SHA512H */
  /** C7.2.235 SHA512H2 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension6, NM("sha512h", "sha512h2"),
       OPS(QREG, QREG, VREG_2D));
  /** C7.2.236 SHA512SU0 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension7, NM("sha512su0"),
       OPS(VREG_2D, VREG_2D));
  /** C7.2.237 SHA512SU1 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension8, NM("sha512su1"),
       OPS(VREG_2D, VREG_2D, VREG_2D));
  /** C7.2.35 EOR3 */
  /** C7.2.12 BCAX */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension9, NM("eor3", "bcax"),
       OPS(VREG_16B, VREG_16B, VREG_16B, VREG_16B));
  /** C7.2.202 RAX1 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension10, NM("rax1"),
       OPS(VREG_2D, VREG_2D, VREG_2D));
  /** C7.2.380 XAR */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension11, NM("xar"),
       OPS(VREG_2D, VREG_2D, VREG_2D, IMM6BIT));
  /** C7.2.246 SM3SS1 */
  /** Advanced SIMD variant */
  PUT1(DataProcSimd_CryptographicExtension12, NM("sm3ss1"),
