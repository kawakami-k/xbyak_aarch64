...
const uint64_t COND = flagBit++; /** Test vector is { EQ, NE, CS, CC, MI, PL,
                                    VS, VC, HI, LS, GE, LT, GT, LE, AL } */
const uint64_t COND_WO_AL =
    flagBit++; /** Test vector is { EQ, NE, CS, CC, MI, PL, VS, VC, HI, LS, GE,
                  LT, GT, LE } */
...
public:
  ...
  */
  ...
  PUT6(Load_Store_register0, NM("ldr", "str"),
       // size == 10
  ...
  PUT8(Load_Store_register1, NM("ldr"),
       // Post-index
       OPS(WREG, SPECIFIC32), OPS(XREG, SPECIFIC64),
       // Pre-index
       OPS(WREG, SPECIFIC32_1), OPS(XREG, SPECIFIC64_1),
       // Unsigned offset
       OPS(WREG, PTR_O, XNSP2, PTR_C), OPS(XREG, PTR_O, XNSP2, PTR_C),
  ...
  PUT2(Load_Store_register2, NM("ldr"), OPS(WREG, IMM19BIT_MUL4),
  ...
  PUT8(Load_Store_register3, NM("ldrb", "strb"),
  ...
  PUT4(Load_Store_register4, NM("ldrb", "strb"),
       // Post-index
       OPS(WREG, SPECIFIC32),
       // Pre-index
  ...
  PUT8(Load_Store_register5, NM("ldrsb"),
       // Post-index
       OPS(WREG, SPECIFIC32), OPS(XREG, SPECIFIC64),
       // Pre-index
       OPS(WREG, SPECIFIC32_1), OPS(XREG, SPECIFIC64_1),
  ...
  PUT8(Load_Store_register6, NM("ldrsb"),
       ...
       OPS(WREG, PTR_O, XNSP2, XREG, PTR_C),
       OPS(WREG, PTR_O, XNSP2, XREG, SPECIFIC11, PTR_C));
  PUT8(Load_Store_register7, NM("ldrsb"),
  ...
  PUT7(Load_Store_register8, NM("ldrsh"),
       // opc == 11
       //// option == 010 -> Wm
       OPS(WREG, PTR_O, XNSP2, WREG, T_UXTW, PTR_C),
       ...
       //// option == 011 -> Xm
       OPS(WREG, PTR_O, XNSP2, XREG, PTR_C));
  PUT7(Load_Store_register9, NM("ldrsh"),
       // opc == 10
       //// option == 010 -> Wm
       OPS(XREG, PTR_O, XNSP2, WREG, T_UXTW, PTR_C),
  ...
  PUT7(Load_Store_register10, NM("ldrh", "strh"),
       // option = 010
       OPS(WREG, PTR_O, XNSP2, WREG, T_UXTW, PTR_C),
       OPS(WREG, PTR_O, XNSP2, WREG, SPECIFIC2, PTR_C),
       // option = 011
  ...
  PUT7(Load_Store_register11, NM("ldrsw"),
       // option = 010
       OPS(XREG, PTR_O, XNSP2, WREG, T_UXTW, PTR_C),
  ...
  PUT4(Load_Store_register12, NM("ldrh", "strh"),
       /**** Post-index */
       OPS(WREG, SPECIFIC64),
       /**** Pre-index */
   ...
   */
  PUT8(Load_Store_register13, NM("ldrsh"),
       /** Post-index */
       OPS(WREG, SPECIFIC64), OPS(XREG, SPECIFIC64),
       /** Pre-index */
       OPS(WREG, SPECIFIC64_1), OPS(XREG, SPECIFIC64_1),
       /** Unsigned offset */
       OPS(WREG, PTR_O, XNSP2, PTR_C),
       OPS(WREG, PTR_O, XNSP2, IMM12BIT_MUL2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, IMM12BIT_MUL2, PTR_C));
  /*** Load signed word (immediate offset) LDRSW (immediate) on page C6-913 */
  PUT4(Load_Store_register14, NM("ldrsw"),
       /**** Post-index */
       OPS(XREG, SPECIFIC32),
       /**** Pre-index */
       OPS(XREG, SPECIFIC64),
  ...
  PUT1(Load_Store_register15, NM("ldrsw"), OPS(XREG, IMM19BIT_MUL4));
  ...
  PUT4(Load_Store_register_unscaled_offset0,
       NM("ldur", "ldursb", "ldursh", "stur"), OPS(WREG, PTR_O, XNSP2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, PTR_C),
  ...
  PUT2(Load_Store_register_unscaled_offset1,
       NM("ldurb", "ldurh", "sturb", "sturh"), OPS(WREG, PTR_O, XNSP2, PTR_C),
       OPS(WREG, PTR_O, XNSP2, IMM9BIT_PM, PTR_C));
  /*** LDURSW Load signed word (unscaled offset) LDURSW on page C6-973 */
  PUT2(Load_Store_register_unscaled_offset2, NM("ldursw"),
       OPS(XREG, PTR_O, XNSP2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, IMM9BIT_PM, PTR_C));
  ...
  PUT8(Load_Store_Non_temporal_Pair0, NM("ldnp", "stnp"),
  ...
  PUT4(Load_Store_unprivileged0, NM("ldtr", "ldtrsb", "ldtrsh", "sttr"),
       OPS(WREG, PTR_O, XNSP2, PTR_C),
       OPS(WREG, PTR_O, XNSP2, IMM9BIT_PM, PTR_C),
       OPS(XREG, PTR_O, XNSP2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, IMM9BIT_PM, PTR_C));
  ...
  PUT2(Load_Store_unprivileged1, NM("ldtrb", "ldtrh", "sttrb", "sttrh"),
       OPS(WREG, PTR_O, XNSP2, PTR_C),
       OPS(WREG, PTR_O, XNSP2, IMM9BIT_PM, PTR_C));
  /*** LDTRSW Load unprivileged signed word LDTRSW on page C6-949 */
  PUT2(Load_Store_unprivileged2, NM("ldtrsw"), OPS(XREG, PTR_O, XNSP2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, IMM9BIT_PM, PTR_C));
  ...
  /*** LDAPURSB Load-Acquire RCpc Register Signed Byte (unscaled) 64-bit
   * LDAPURSB on page C6-844 */
  /*** LDAPURSH Load-Acquire RCpc Register Signed Halfword (unscaled) 32-bit
   * LDAPURSH on page C6-846 */
  /*** LDAPURSH Load-Acquire RCpc Register Signed Halfword (unscaled) 64-bit
   * LDAPURSH on page C6-846 */
  ...
  PUT4(LoadLOAcquire_StoreLORelease1, NM("ldlar", "stllr"),
       OPS(WREG, PTR_O, XNSP2, PTR_C),
       OPS(WREG, PTR_O, XNSP2, SPECIFIC0, PTR_C),
       OPS(XREG, PTR_O, XNSP2, PTR_C),
       OPS(XREG, PTR_O, XNSP2, SPECIFIC0, PTR_C));
  ...
  void putLoadStoreRegisterOffset() {
...

    {
      ...
      setTvAddressing(tv_SPECIFIC32, jtv_SPECIFIC32, tmpX, tv_IMM9BIT_PM,
                      TP_PostImm);
      setTvAddressing(tv_SPECIFIC64, jtv_SPECIFIC64, tmpX, tv_IMM9BIT_PM,
                      TP_PostImm);
      setTvAddressing(tv_SPECIFIC32_1, jtv_SPECIFIC32_1, tmpX, tv_IMM9BIT_PM,
                      TP_PreImm);
      setTvAddressing(tv_SPECIFIC64_1, jtv_SPECIFIC64_1, tmpX, tv_IMM9BIT_PM,
                      TP_PreImm);

      setTvAddressing(tv_SPECIFIC32_2, jtv_SPECIFIC32_2, tmpX, tv_IMM12BIT,
                      TP_None);
      setTvAddressing(tv_SPECIFIC64_2, jtv_SPECIFIC64_2, tmpX, tv_IMM12BIT,
                      TP_None);
    }
  ...
  void putLoadStorePair() {
    ...
    std::vector<int> imm7bit_pm = {31, -64, -32, -16, -8, -4, -2, -1,
                                   0,  1,   2,   4,   8,  16, 32, 63};
    ...
    setTvAddressing(tv_SPECIFIC0, jtv_SPECIFIC0, tmpX, imm7bit_pm_mul4,
                    TP_PostImm);
    setTvAddressing(tv_SPECIFIC1, jtv_SPECIFIC1, tmpX, imm7bit_pm_mul8,
                    TP_PostImm);

    setTvAddressing(tv_SPECIFIC2, jtv_SPECIFIC2, tmpX, imm7bit_pm_mul4,
                    TP_PreImm);
    setTvAddressing(tv_SPECIFIC3, jtv_SPECIFIC3, tmpX, imm7bit_pm_mul8,
                    TP_PreImm);

    setTvAddressing(tv_SPECIFIC4, jtv_SPECIFIC4, tmpX, imm7bit_pm_mul4,
                    TP_None);
    setTvAddressing(tv_SPECIFIC5, jtv_SPECIFIC5, tmpX, imm7bit_pm_mul8,
                    TP_None);
  ...
  void putLoadStoreUnprivileged() { putLoadStoreUnprivileged_core(); }
