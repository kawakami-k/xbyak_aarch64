...
uint64_t flagBit = 0;
const uint64_t WREG =
    1ULL << flagBit++; /** Test vector is {w0, w1, ..., w30 } */
const uint64_t XREG =
    1ULL << flagBit++; /** Test vector is {x0, x1, ..., x30 } */
const uint64_t VREG =
    1ULL << flagBit++; /** Test vector is {v0, v1, ..., v31 } */
...
const uint64_t IMM3BIT = 1ULL
                         << flagBit++; /** Test vector is {0, 1, 2, 4, 7 } */
const uint64_t IMM4BIT = 1ULL
                         << flagBit++; /** Test vector is {0, 1, ..., 8, 15 } */
const uint64_t IMM5BIT =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 16, 31 } */
const uint64_t IMM6BIT =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 32, 63 } */
const uint64_t IMM8BIT =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 128, 255 } */
const uint64_t IMM12BIT =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 2048, 4095 } */
const uint64_t IMM13BIT =
    1ULL << flagBit++; /** Test vector is {0, 1, ..., 4096, 8191 } */
const uint64_t IMM16BIT = 1ULL
                          << flagBit++; /** Test vector is {0, 1, ..., 4096,
                                           1<<13, 1<<14, 1<<15, 1<<16-1 } */
const uint64_t IMM3BIT_N = 1ULL
                           << flagBit++; /** Test vector is {1, 2, .., 8 } */
const uint64_t IMM4BIT_N = 1ULL
                           << flagBit++; /** Test vector is {1, 2, .., 16 } */
const uint64_t IMM5BIT_N = 1ULL
                           << flagBit++; /** Test vector is {1, 2, .., 32 } */
const uint64_t IMM6BIT_N = 1ULL
                           << flagBit++; /** Test vector is {1, 2, .., 64 } */
const uint64_t FLOAT8BIT = 1ULL
                           << flagBit++; /** Test vector is Table C-2-
                                            Floating-point constant values */

const uint64_t BREG =
    1ULL << flagBit++; /** Test vector is { b0, b1, ..., b31 } */
const uint64_t HREG =
    1ULL << flagBit++; /** Test vector is { h0, h1, ..., h31 } */
const uint64_t SREG =
    1ULL << flagBit++; /** Test vector is { s0, s1, ..., s31 } */
const uint64_t DREG =
    1ULL << flagBit++; /** Test vector is { d0, d1, ..., d31 } */
const uint64_t QREG =
    1ULL << flagBit++; /** Test vector is { q0, q1, ..., q31 } */
const uint64_t ZREG =
    1ULL << flagBit++; /** Test vector is { z0, z1, ..., z31 } */

const uint64_t SPECIFIC32 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
...
const uint64_t SPECIFIC64_3 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
const uint64_t SPECIFIC32_4 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
const uint64_t SPECIFIC64_4 =
    1ULL << flagBit++; /** Test vector is generated on the fly. */
...
#define PUT11(name, nm, op_1, op_2, op_3, op_4, op_5, op_6, op_7, op_8, op_9,  \
              op_10, op_11)                                                    \
  PUT8(name, nm, op_1, op_2, op_3, op_4, op_5, op_6, op_7, op_8)               \
  PUT2(name, nm, op_9, op_10, op_11)

#define PUT17(name, nm, op_1, op_2, op_3, op_4, op_5, op_6, op_7, op_8, op_9,  \
...
class Test {
  ...
  std::vector<std::string> tv_IMM6BIT = {"0x39", "0",  "1",  "2", "4",
                                         "8",    "16", "32", "63"};
  std::vector<std::string> tv_IMM8BIT = {"0x39", "0",  "1",  "2",   "4",  "8",
                                         "16",   "32", "64", "128", "255"};
  ...
  std::vector<std::string> tv_IMM6BIT_N = {"1",  "2",  "4", "8",
                                           "16", "32", "64"};
  std::vector<std::string> tv_FLOAT8BIT = {
      "2.0",       "4.0",     "8.0",     "16.0", "0.125",   "0.25",
      "0.5",       "1.0",     "2.125",   "4.5",  "9.5",     "20.0",
      "0.1640625", "0.34375", "0.71875", "1.5",  "0.78125", "0.40625",
  ...
  std::vector<std::string> tv_SPECIFIC32, tv_SPECIFIC64, tv_SPECIFIC32_1,
      ...
      tv_SPECIFIC64_3, tv_SPECIFIC32_4, tv_SPECIFIC64_4;
  std::vector<std::string> jtv_SPECIFIC32, jtv_SPECIFIC64, jtv_SPECIFIC32_1,
      ...
      jtv_SPECIFIC64_3, jtv_SPECIFIC32_4, jtv_SPECIFIC64_4;

  std::vector<std::string> tv_ZREG_B = {"z7.b", "z0.b", "z1.b",  "z2.b",
                                        "z4.b", "z8.b", "z16.b", "z31.b"};
  std::vector<std::string> tv_ZREG_H = {"z7.h", "z0.h", "z1.h",  "z2.h",
                                        "z4.h", "z8.h", "z16.h", "z31.h"};
  std::vector<std::string> tv_ZREG_S = {"z7.s", "z0.s", "z1.s",  "z2.s",
                                        "z4.s", "z8.s", "z16.s", "z31.s"};
  std::vector<std::string> tv_ZREG_D = {"z7.d", "z0.d", "z1.d",  "z2.d",
                                        "z4.d", "z8.d", "z16.d", "z31.d"};
  std::vector<std::string> tv_ZREG_Q = {"z7.q", "z0.q", "z1.q",  "z2.q",
                                        "z4.q", "z8.q", "z16.q", "z31.q"};

  std::vector<std::string> tv_ZREG_B_ELEM, tv_ZREG_H_ELEM, tv_ZREG_S_ELEM,
      tv_ZREG_D_ELEM;
  ...
  std::vector<std::string> jtv_PG_M = {"p7/T_m", "p0/T_m", "p1/T_m", "p2/T_m",
                                       "p4/T_m"};
  std::vector<std::string> jtv_PG_Z = {"p7/T_z", "p0/T_z", "p1/T_z", "p2/T_z",
                                       "p4/T_z"};
  std::vector<std::string> tv_PG = {"p7", "p0", "p1", "p2", "p4"};
  std::vector<std::string> tv_PATTERN = {
      "POW2", "VL1",  "VL2",  "VL3",   "VL4",   "VL5",  "VL6",  "VL7", "VL8",
      "VL16", "VL32", "VL64", "VL128", "VL256", "MUL4", "MUL3", "ALL"};
  std::vector<std::string> tv_SFLOAT8BIT = {
      "0.2421875", "-0.46875", "-0.90625", "-1.75", "-3.375",    "-6.5",
      "-12.5",     "-24.0",    "-0.125",   "0.25",  "0.53125",   "1.125",
      "2.375",     "5.0",      "10.5",     "22.0",  "0.2421875", "0.484375",
      "0.96875",   "1.9375",   "3.875",    "7.75",  "15.5",      "31.0"};

  std::vector<std::vector<std::string> *> tv_VectorsAs = {
      &tv_WREG,         &tv_XREG,         &tv_VREG,         &tv_IMM0BIT,
      &tv_IMM1BIT,      &tv_IMM2BIT,      &tv_IMM3BIT,      &tv_IMM4BIT,
      &tv_IMM5BIT,      &tv_IMM6BIT,      &tv_IMM8BIT,      &tv_IMM12BIT,
      &tv_IMM13BIT,     &tv_IMM16BIT,     &tv_IMM3BIT_N,    &tv_IMM4BIT_N,
      &tv_IMM5BIT_N,    &tv_IMM6BIT_N,    &tv_FLOAT8BIT,    &tv_BREG,
      &tv_HREG,         &tv_SREG,         &tv_DREG,         &tv_QREG,
      &tv_ZREG,         &tv_SPECIFIC32,   &tv_SPECIFIC64,   &tv_SPECIFIC32_1,
      &tv_SPECIFIC64_1, &tv_SPECIFIC32_2, &tv_SPECIFIC64_2, &tv_SPECIFIC32_3,
      &tv_SPECIFIC64_3, &tv_SPECIFIC32_4, &tv_SPECIFIC64_4, &tv_ZREG_B,
      &tv_ZREG_H,       &tv_ZREG_S,       &tv_ZREG_D,       &tv_ZREG_Q,
      &tv_ZREG_B_ELEM,  &tv_ZREG_H_ELEM,  &tv_ZREG_S_ELEM,  &tv_ZREG_D_ELEM,
      &tv_PREG_B,       &tv_PREG_H,       &tv_PREG_S,       &tv_PREG_D,
      &tv_PG_M,         &tv_PG_Z,         &tv_PG,           &tv_PATTERN,
      &tv_SFLOAT8BIT};
  std::vector<std::vector<std::string> *> tv_VectorsJit = {
      &tv_WREG,          &tv_XREG,          &tv_VREG,
      &tv_IMM0BIT,       &tv_IMM1BIT,       &tv_IMM2BIT,
      &tv_IMM3BIT,       &tv_IMM4BIT,       &tv_IMM5BIT,
      &tv_IMM6BIT,       &tv_IMM8BIT,       &tv_IMM12BIT,
      &tv_IMM13BIT,      &tv_IMM16BIT,      &tv_IMM3BIT_N,
      &tv_IMM4BIT_N,     &tv_IMM5BIT_N,     &tv_IMM6BIT_N,
      &tv_FLOAT8BIT,     &tv_BREG,          &tv_HREG,
      &tv_SREG,          &tv_DREG,          &tv_QREG,
      &tv_ZREG,          &jtv_SPECIFIC32,   &jtv_SPECIFIC64,
      &jtv_SPECIFIC32_1, &jtv_SPECIFIC64_1, &jtv_SPECIFIC32_2,
      &jtv_SPECIFIC64_2, &jtv_SPECIFIC32_3, &jtv_SPECIFIC64_3,
      &jtv_SPECIFIC32_4, &jtv_SPECIFIC64_4, &tv_ZREG_B,
      &tv_ZREG_H,        &tv_ZREG_S,        &tv_ZREG_D,
      &tv_ZREG_Q,        &tv_ZREG_B_ELEM,   &tv_ZREG_H_ELEM,
      &tv_ZREG_S_ELEM,   &tv_ZREG_D_ELEM,   &tv_PREG_B,
      &tv_PREG_H,        &tv_PREG_S,        &tv_PREG_D,
      &jtv_PG_M,         &jtv_PG_Z,         &tv_PG,
      &tv_PATTERN,       &tv_SFLOAT8BIT};
  ...
  std::vector<std::string> tmp8B = {"8b[7]", "8b[0]", "8b[1]", "8b[2]",
                                    "8b[4]"};
  std::vector<std::string> tmp16B = {"16b[15]", "16b[0]", "16b[1]",
                                     "16b[2]",  "16b[4]", "16b[8]"};
  std::vector<std::string> tmp4H = {"4h[3]", "4h[0]", "4h[1]", "4h[2]"};
  std::vector<std::string> tmp8H = {"8h[7]", "8h[0]", "8h[1]", "8h[2]",
                                    "8h[4]"};
  ...
  std::vector<std::string> tmpB = {"b[15]", "b[0]", "b[1]",
                                   "b[2]",  "b[4]", "b[8]"};
  ...
  std::vector<std::string> jtmp8B = {"b8[7]", "b8[0]", "b8[1]", "b8[2]",
                                     "b8[4]"};
  std::vector<std::string> jtmp16B = {"b16[15]", "b16[0]", "b16[1]",
                                      "b16[2]",  "b16[4]", "b16[8]"};
  std::vector<std::string> jtmp4H = {"h4[3]", "h4[0]", "h4[1]", "h4[2]"};
  std::vector<std::string> jtmp8H = {"h8[7]", "h8[0]", "h8[1]", "h8[2]",
                                     "h8[4]"};
  ...
  std::vector<std::string> jtmpB = {"b[15]", "b[0]", "b[1]",
                                    "b[2]",  "b[4]", "b[8]"};
      ...
      for (j = 0; j < bitEnd; j++) {
        ...
        */
        ...
        if (ops[i] & (1ULL << j)) {
          ...
          std::cout << "Debug:" << __LINE__ << ":" << getBaseStr(ops[i]) <<
          std::endl;
          */
...
public:
  ...
  void setZregElem(std::vector<std::string> &tv, std::vector<int> &regs,
                   std::vector<int> &index, std::string type) {
    tv.clear();
  ...
  void setDstPred1stSrcZreg(TpPredType predType, std::vector<std::string> &tv,
                            std::vector<std::string> &jtv, std::string type,
  ...
  void setDst1stSrcZreg(std::vector<std::string> &tv,
                        std::vector<std::string> &jtv, std::string type,
                        std::vector<std::string> &tmpDst) {
  ...
  void setRotatedOnes(std::vector<std::string> &tv,
                      std::vector<std::string> &jtv, int dataSize) {
    uint64_t mask = 0;
    ...
    default:
      std::cerr << __FILE__ << ":" << __LINE__ << ":"
                << "Invalid datasize=" << dataSize << std::endl;
      std::exit(1);
      break;
    }
  ...
  void setZregTypeIndex(std::vector<std::string> &tv,
                        std::vector<std::string> &jtv,
                        std::vector<std::string> &baseVec,
                        std::vector<int> idxVec, std::string type) {
    tv.clear();
    jtv.clear();
  ...
  */
  ...
  PUT4(SVE_integer_add_subtract_vectors_predicated0, NM("add", "sub", "subr"),
  ...
  PUT4(SVE_integer_multiply_vectors_predicated0, NM("mul", "smulh", "umulh"),
       OPS(SPECIFIC32, ZREG_B), OPS(SPECIFIC32_1, ZREG_H),
       OPS(SPECIFIC32_2, ZREG_S), OPS(SPECIFIC32_3, ZREG_D));
  ...
  PUT2(SVE_integer_divide_vectors_predicate0,
       NM("sdiv", "udiv", "sdivr", "udivr"), OPS(SPECIFIC32_2, ZREG_S),
       OPS(SPECIFIC32_3, ZREG_D));
  ...
  PUT4(SVE_bitwise_logical_operations_predicated0,
       NM("orr", "eor", "and_", "bic"), OPS(SPECIFIC32, ZREG_B),
       OPS(SPECIFIC32_1, ZREG_H), OPS(SPECIFIC32_2, ZREG_S),
       OPS(SPECIFIC32_3, ZREG_D));
  ...
  PUT3(SVE_integer_add_reduction_predicated0, NM("saddv", "uaddv"),
  ...
  PUT4(SVE_integer_min_max_reduction_predicated0,
       NM("smaxv", "umaxv", "sminv", "uminv"), OPS(BREG, PG, ZREG_B),
  ...
  PUT4(SVE_constructive_prefix_predicated0, NM("movprfx"),
       OPS(ZREG_B, PG_ZM, ZREG_B), OPS(ZREG_H, PG_ZM, ZREG_H),
       OPS(ZREG_S, PG_ZM, ZREG_S), OPS(ZREG_D, PG_ZM, ZREG_D));
  ...
  PUT4(SVE_bitwise_logical_reduction_predicated0, NM("orv", "eorv", "andv"),
       OPS(BREG, PG, ZREG_B), OPS(HREG, PG, ZREG_H), OPS(SREG, PG, ZREG_S),
       OPS(DREG, PG, ZREG_D));
  ...
  PUT4(SVE_bitwise_shift_by_immediate_predicated0, NM("asr", "lsr", "asrd"),
       OPS(SPECIFIC32, IMM3BIT_N), OPS(SPECIFIC32_1, IMM4BIT_N),
       OPS(SPECIFIC32_2, IMM5BIT_N), OPS(SPECIFIC32_3, IMM6BIT_N));
  PUT4(SVE_bitwise_shift_by_immediate_predicated1, NM("lsl"),
  ...
  PUT4(SVE_bitwise_shift_by_vector_predicated0,
       NM("asr", "lsr", "lsl", "asrr", "lsrr", "lslr"), OPS(SPECIFIC32, ZREG_B),
       OPS(SPECIFIC32_1, ZREG_H), OPS(SPECIFIC32_2, ZREG_S),
       OPS(SPECIFIC32_3, ZREG_D));
  ...
  PUT3(SVE_bitwise_shift_by_wide_elements_predicated0, NM("asr", "lsr", "lsl"),
  ...
  PUT3(SVE_integer_unary_operations_predicated0, NM("sxtb", "uxtb"),
       OPS(ZREG_H, PG_M, ZREG_H), OPS(ZREG_S, PG_M, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D));
  PUT2(SVE_integer_unary_operations_predicated1, NM("sxth", "uxth"),
       OPS(ZREG_S, PG_M, ZREG_S), OPS(ZREG_D, PG_M, ZREG_D));
  PUT1(SVE_integer_unary_operations_predicated2, NM("sxtw", "uxtw"),
       OPS(ZREG_D, PG_M, ZREG_D));
  PUT4(SVE_integer_unary_operations_predicated3, NM("abs", "neg"),
  ...
  PUT4(SVE_bitwise_unary_operations_predicated0,
       NM("cls", "clz", "cnt", "cnot", "not_"), OPS(ZREG_B, PG_M, ZREG_B),
       OPS(ZREG_H, PG_M, ZREG_H), OPS(ZREG_S, PG_M, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D));
  PUT3(SVE_bitwise_unary_operations_predicated1, NM("fabs", "fneg"),
       OPS(ZREG_H, PG_M, ZREG_H), OPS(ZREG_S, PG_M, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D));
  ...
  PUT4(SVE_integer_multiply_accumulate_writing_addend_predicated0,
       NM("mla", "mls"), OPS(ZREG_B, PG_M, ZREG_B, ZREG_B),
  ...
  PUT4(SVE_integer_multiply_add_writing_multiplicand_predicated0,
       NM("mad", "msb"), OPS(ZREG_B, PG_M, ZREG_B, ZREG_B),
       OPS(ZREG_H, PG_M, ZREG_H, ZREG_H), OPS(ZREG_S, PG_M, ZREG_S, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D, ZREG_D));
  ...
  PUT1(SVE_bitwise_logical_operations_unpredicated0,
       NM("and_", "orr", "eor", "bic"), OPS(ZREG_D, ZREG_D, ZREG_D));
  ...
  PUT4(SVE_index_generation_immediate_start_immediate_increment0, NM("index"),
       OPS(ZREG_B, SPECIFIC32, SPECIFIC32), OPS(ZREG_H, SPECIFIC32, SPECIFIC32),
       OPS(ZREG_S, SPECIFIC32, SPECIFIC32),
       OPS(ZREG_D, SPECIFIC32, SPECIFIC32));
  ...
  PUT4(SVE_index_generation_register_start_immediate_increment0, NM("index"),
  ...
  PUT4(SVE_index_generation_immediate_start_register_increment0, NM("index"),
  ...
  PUT4(SVE_index_generation_register_start_register_increment0, NM("index"),
  ...
  PUT1(SVE_stack_frame_adjustment0, NM("addvl", "addpl"),
       OPS(XREG, XREG, SPECIFIC32));

  void putSVE_stack_frame_adjustment() { putSVE_stack_frame_adjustment0(); }

  /*** SVE stack frame size */
  PUT1(SVE_stack_frame_size0, NM("rdvl"), OPS(XREG, SPECIFIC32));

  void putSVE_stack_frame_size() { putSVE_stack_frame_size0(); }

  /** SVE Bitwise Shift - Unpredicated */
  /*** SVE bitwise shift by wide elements (unpredicated) */
  PUT3(SVE_bitwise_shift_by_wide_elements_unpredicated0,
       NM("asr", "lsr", "lsl"), OPS(ZREG_B, ZREG_B, ZREG_D),
       OPS(ZREG_H, ZREG_H, ZREG_D), OPS(ZREG_S, ZREG_S, ZREG_D));
  ...
  PUT4(SVE_bitwise_shift_by_immediate_unpredicated0, NM("asr", "lsr"),
       OPS(ZREG_B, ZREG_B, IMM3BIT_N), OPS(ZREG_H, ZREG_H, IMM4BIT_N),
       OPS(ZREG_S, ZREG_S, IMM5BIT_N), OPS(ZREG_D, ZREG_D, IMM6BIT_N));
  PUT4(SVE_bitwise_shift_by_immediate_unpredicated1, NM("lsl"),
  ...
  PUT1(SVE_address_generation0, NM("adr"), OPS(ZREG_D, SPECIFIC32));
  PUT2(SVE_address_generation1, NM("adr"), OPS(ZREG_S, SPECIFIC32_1),
  ...
  PUT3(SVE_floating_point_trig_select_coefficient0, NM("ftssel"),
  ...
  PUT3(SVE_floating_point_exponential_accelerator0, NM("fexpa"),
  ...
  PUT1(SVE_constructive_prefix_unpredicated0, NM("movprfx"), OPS(ZREG, ZREG));
  ...
  PUT6(SVE_saturating_inc_dec_register_by_element_count0,
       NM("sqincb", "sqdecb", "sqinch", "sqdech", "sqincw", "sqdecw", "sqincd",
          "sqdecd"),
       OPS(SPECIFIC32_1), OPS(SPECIFIC32_1, PATTERN),
       OPS(SPECIFIC32_1, PATTERN, SPECIFIC32), OPS(XREG), OPS(XREG, PATTERN),
       OPS(XREG, PATTERN, SPECIFIC32));
  PUT6(SVE_saturating_inc_dec_register_by_element_count1,
       NM("uqincb", "uqdecb", "uqinch", "uqdech", "uqincw", "uqdecw", "uqincd",
          "uqdecd"),
       OPS(WREG), OPS(WREG, PATTERN), OPS(WREG, PATTERN, SPECIFIC32), OPS(XREG),
       OPS(XREG, PATTERN), OPS(XREG, PATTERN, SPECIFIC32));
  ...
  PUT3(SVE_saturating_inc_dec_vector_by_element_count0,
       NM("sqinch", "uqinch", "sqdech", "uqdech"), OPS(ZREG_H),
       OPS(ZREG_H, PATTERN), OPS(ZREG_H, PATTERN, SPECIFIC32));
  PUT3(SVE_saturating_inc_dec_vector_by_element_count1,
       NM("sqincw", "uqincw", "sqdecw", "uqdecw"), OPS(ZREG_S),
       OPS(ZREG_S, PATTERN), OPS(ZREG_S, PATTERN, SPECIFIC32));
  PUT3(SVE_saturating_inc_dec_vector_by_element_count2,
       NM("sqincd", "uqincd", "sqdecd", "uqdecd"), OPS(ZREG_D, ),
       OPS(ZREG_D, PATTERN), OPS(ZREG_D, PATTERN, SPECIFIC32));
  ...
  /*** SVE element count */
  PUT3(SVE_element_count0, NM("cntb", "cntd", "cnth", "cntw"), OPS(XREG),
       OPS(XREG, PATTERN), OPS(XREG, PATTERN, SPECIFIC32));

  void putSVE_element_count() { putSVE_element_count0(); }

  /*** SVE inc/dec vector by element count */
  PUT3(SVE_inc_dec_vector_by_element_count0, NM("incd", "decd"), OPS(ZREG_D),
       OPS(ZREG_D, PATTERN), OPS(ZREG_D, PATTERN, SPECIFIC32));
  PUT3(SVE_inc_dec_vector_by_element_count1, NM("inch", "dech"), OPS(ZREG_H),
       OPS(ZREG_H, PATTERN), OPS(ZREG_H, PATTERN, SPECIFIC32));
  PUT3(SVE_inc_dec_vector_by_element_count2, NM("incw", "decw"), OPS(ZREG_S),
       OPS(ZREG_S, PATTERN), OPS(ZREG_S, PATTERN, SPECIFIC32));
  ...
  PUT3(SVE_inc_dec_register_by_element_count0, NM("incb", "decb"), OPS(XREG),
       OPS(XREG, PATTERN), OPS(XREG, PATTERN, SPECIFIC32));
  PUT3(SVE_inc_dec_register_by_element_count1, NM("incd", "decd"), OPS(XREG),
       OPS(XREG, PATTERN), OPS(XREG, PATTERN, SPECIFIC32));
  PUT3(SVE_inc_dec_register_by_element_count2, NM("inch", "dech"), OPS(XREG),
       OPS(XREG, PATTERN), OPS(XREG, PATTERN, SPECIFIC32));
  PUT3(SVE_inc_dec_register_by_element_count3, NM("incw", "decw"), OPS(XREG),
       OPS(XREG, PATTERN), OPS(XREG, PATTERN, SPECIFIC32));
  ...
  PUT4(SVE_bitwise_logical_with_immediate_unpredicated0,
       NM("orr", "eor", "and_"), OPS(SPECIFIC32, SPECIFIC64),
       OPS(SPECIFIC32_1, SPECIFIC64_1), OPS(SPECIFIC32_2, SPECIFIC64_2),
       OPS(SPECIFIC32_3, SPECIFIC64_3));
  ...
  PUT4(SVE_broadcast_bitmask_immediate0, NM("dupm"), OPS(ZREG_D, SPECIFIC64_3),
       OPS(ZREG_S, SPECIFIC64_2), OPS(ZREG_H, SPECIFIC64_1),
       OPS(ZREG_B, SPECIFIC64));
  ...
  PUT8(SVE_copy_integer_immediate_predicated0, NM("cpy"),
       OPS(ZREG_B, PG_ZM, SPECIFIC32),
       OPS(ZREG_B, PG_ZM, SPECIFIC32, SPECIFIC64_1),
       OPS(ZREG_H, PG_ZM, SPECIFIC32),
       OPS(ZREG_H, PG_ZM, SPECIFIC32, SPECIFIC64),
       OPS(ZREG_S, PG_ZM, SPECIFIC32),
       OPS(ZREG_S, PG_ZM, SPECIFIC32, SPECIFIC64),
       OPS(ZREG_D, PG_ZM, SPECIFIC32),
       OPS(ZREG_D, PG_ZM, SPECIFIC32, SPECIFIC64));
  ...
  PUT3(SVE_copy_floating_point_immediate_predicated0, NM("fcpy"),
       OPS(ZREG_H, PG_M, SFLOAT8BIT), OPS(ZREG_S, PG_M, SFLOAT8BIT),
  ...
  PUT1(SVE_extract_vector_immediate_offset_destructive0, NM("ext"),
  ...
  PUT5(SVE_broadcast_indexed_element0, NM("dup"), OPS(ZREG_B, SPECIFIC32),
       OPS(ZREG_H, SPECIFIC32_1), OPS(ZREG_S, SPECIFIC32_2),
  ...
  /*** SVE table lookup */
  PUT4(SVE_table_lookup0, NM("tbl"), OPS(ZREG_B, ZREG_B, ZREG_B),
       OPS(ZREG_H, ZREG_H, ZREG_H), OPS(ZREG_S, ZREG_S, ZREG_S),
       OPS(ZREG_D, ZREG_D, ZREG_D));

  void putSVE_table_lookup() { putSVE_table_lookup0(); }

  /*** SVE broadcast general register */
  PUT4(SVE_broadcast_general_register0, NM("dup"), OPS(ZREG_B, WREG),
       OPS(ZREG_H, WREG), OPS(ZREG_S, WREG), OPS(ZREG_D, XREG));
  ...
  PUT4(SVE_insert_general_register0, NM("insr"), OPS(ZREG_B, WREG),
       OPS(ZREG_H, WREG), OPS(ZREG_S, WREG), OPS(ZREG_D, XREG));

  void putSVE_insert_general_register() { putSVE_insert_general_register0(); }

  /*** SVE unpack vector elements */
  PUT3(SVE_unpack_vector_elements0,
       NM("sunpkhi", "sunpklo", "uunpkhi", "uunpklo"), OPS(ZREG_H, ZREG_B),
       OPS(ZREG_S, ZREG_H), OPS(ZREG_D, ZREG_S));
  void putSVE_unpack_vector_elements() { putSVE_unpack_vector_elements0(); }

  /*** SVE insert SIMD&FP scalar register */
  PUT4(SVE_insert_SIMD_FP_scalar_register0, NM("insr"), OPS(ZREG_B, BREG),
       OPS(ZREG_H, HREG), OPS(ZREG_S, SREG), OPS(ZREG_D, DREG));
  ...
  PUT4(SVE_reverse_vector_elements0, NM("rev"), OPS(ZREG_B, ZREG_B),
       OPS(ZREG_H, ZREG_H), OPS(ZREG_S, ZREG_S), OPS(ZREG_D, ZREG_D));

  void putSVE_reverse_vector_elements() { putSVE_reverse_vector_elements0(); }
  ...
  PUT4(SVE_reverse_predicate_elements0, NM("rev"), OPS(PREG_B, PREG_B),
       OPS(PREG_H, PREG_H), OPS(PREG_S, PREG_S), OPS(PREG_D, PREG_D));
  ...
  PUT1(SVE_unpack_predicate_elements0, NM("punpkhi", "punpklo"),
       OPS(PREG_H, PREG_B));
  ...
  void putSVE_permute_vector_elements() { putSVE_permute_vector_elements0(); }

  /** SVE Permute Vector - Predicated */
  /*** SVE extract element to general register */
  PUT4(SVE_extract_element_to_general_register0, NM("lasta", "lastb"),
       OPS(WREG, PG, ZREG_B), OPS(WREG, PG, ZREG_H), OPS(WREG, PG, ZREG_S),
       OPS(XREG, PG, ZREG_D));
  ...
  PUT4(SVE_copy_SIMD_FP_scalar_register_to_vector_predicated0, NM("cpy"),
  ...
  PUT4(SVE_extract_element_to_SIMD_FP_scalar_register0, NM("lasta", "lastb"),
       OPS(BREG, PG, ZREG_B), OPS(HREG, PG, ZREG_H), OPS(SREG, PG, ZREG_S),
       OPS(DREG, PG, ZREG_D));
  ...
  PUT3(SVE_reverse_within_elements0, NM("revb"), OPS(ZREG_H, PG_M, ZREG_H),
       OPS(ZREG_S, PG_M, ZREG_S), OPS(ZREG_D, PG_M, ZREG_D));
  PUT2(SVE_reverse_within_elements1, NM("revh"), OPS(ZREG_S, PG_M, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D));
  PUT1(SVE_reverse_within_elements2, NM("revw"), OPS(ZREG_D, PG_M, ZREG_D));
  PUT4(SVE_reverse_within_elements3, NM("rbit"), OPS(ZREG_B, PG_M, ZREG_B),
       OPS(ZREG_H, PG_M, ZREG_H), OPS(ZREG_S, PG_M, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D));
  ...
  PUT4(SVE_conditionally_broadcast_element_to_vector0, NM("clasta", "clastb"),
       OPS(SPECIFIC32, ZREG_B), OPS(SPECIFIC32_1, ZREG_H),
       OPS(SPECIFIC32_2, ZREG_S), OPS(SPECIFIC32_3, ZREG_D));
  ...
  PUT4(SVE_copy_general_register_to_vector_predicated0, NM("cpy"),
  ...
  PUT4(SVE_conditionally_extract_element_to_SIMD_FP_scalar0,
       NM("clasta", "clastb"), OPS(SPECIFIC64, ZREG_B),
       OPS(SPECIFIC64_1, ZREG_H), OPS(SPECIFIC64_2, ZREG_S),
       OPS(SPECIFIC64_3, ZREG_D));
  ...
  PUT4(SVE_vector_splice_destructive0, NM("splice"), OPS(SPECIFIC64, ZREG_B),
       OPS(SPECIFIC64_1, ZREG_H), OPS(SPECIFIC64_2, ZREG_S),
       OPS(SPECIFIC64_3, ZREG_D));
  ...
  PUT4(SVE_conditionally_extract_element_to_general_register0,
       NM("clasta", "clastb"), OPS(SPECIFIC32_4, ZREG_B),
       OPS(SPECIFIC32_4, ZREG_H), OPS(SPECIFIC32_4, ZREG_S),
       OPS(SPECIFIC64_4, ZREG_D));
  ...
  PUT2(SVE_compress_active_elements0, NM("compact"), OPS(ZREG_S, PG, ZREG_S),
       OPS(ZREG_D, PG, ZREG_D));

  void putSVE_compress_active_elements() { putSVE_compress_active_elements0(); }

  /** SVE Vector Select */
  /*** SVE select vector elements (predicated) */
  PUT4(SVE_select_vector_elements_predicated0, NM("sel"),
  ...
  PUT3(SVE_integer_compare_vectors1, NM("cmpeq", "cmpne"),
  ...
  PUT3(SVE_integer_compare_with_wide_elements0,
       NM("cmpge", "cmpgt", "cmplt", "cmple", "cmphs", "cmphi", "cmplo",
          "cmpls"),
       OPS(PREG_B, PG_Z, ZREG_B, ZREG_D), OPS(PREG_H, PG_Z, ZREG_H, ZREG_D),
       OPS(PREG_S, PG_Z, ZREG_S, ZREG_D));
  ...
  PUT1(SVE_predicate_logical_operations0,
       NM("and_", "ands", "bic", "bics", "eor", "eors", "orr", "orrs", "orn",
          "orns", "nor", "nors", "nand", "nands"),
       OPS(PREG_B, PG_Z, PREG_B, PREG_B));
  PUT1(SVE_predicate_logical_operations1, NM("sel"),
  ...
  PUT1(SVE_partition_break_condition0, NM("brka", "brkb"),
       OPS(PREG_B, PG_ZM, PREG_B));
  PUT1(SVE_partition_break_condition1, NM("brka", "brkb"),
  ...
  PUT1(SVE_propagate_break_to_next_partition0, NM("brkn", "brkns"),
       OPS(SPECIFIC32));
  ...
  /** SVE Predicate Misc */
  /*** SVE predicate test*/
  PUT1(SVE_predicate_test0, NM("ptest"), OPS(PG, PREG_B));

  void putSVE_predicate_test() { putSVE_predicate_test0(); }

  /*** SVE predicate initialize */
  PUT8(SVE_predicate_initialize0, NM("ptrue", "ptrues"), OPS(PREG_B),
       OPS(PREG_B, PATTERN), OPS(PREG_H), OPS(PREG_H, PATTERN), OPS(PREG_S),
       OPS(PREG_S, PATTERN), OPS(PREG_D), OPS(PREG_D, PATTERN));

  void putSVE_predicate_initialize() { putSVE_predicate_initialize0(); }

  /*** SVE predicate first active */
  PUT1(SVE_predicate_first_active0, NM("pfirst"), OPS(SPECIFIC32));

  void putSVE_predicate_first_active() { putSVE_predicate_first_active0(); }

  /*** SVE predicate zero */
  PUT1(SVE_predicate_zero0, NM("pfalse"), OPS(PREG_B));

  void putSVE_predicate_zero() { putSVE_predicate_zero0(); }

  /*** SVE predicate read from FFR (predicated) */
  PUT1(SVE_predicate_read_from_FFR_predicated0, NM("rdffr", "rdffrs"),
       OPS(PREG_B, PG_Z));
  ...
  PUT4(SVE_predicate_next_active0, NM("pnext"), OPS(SPECIFIC32),
       OPS(SPECIFIC32_1), OPS(SPECIFIC32_2), OPS(SPECIFIC32_3));

  void putSVE_predicate_next_active() { putSVE_predicate_next_active0(); }

  /*** SVE predicate read from FFR (unpredicated) */
  PUT1(SVE_predicate_read_from_FFR_unpredicated0, NM("rdffr"), OPS(PREG_B));
  ...
  PUT4(SVE_integer_compare_with_signed_immediate0,
       ...
       OPS(PREG_B, PG_Z, ZREG_B, SPECIFIC32),
       OPS(PREG_H, PG_Z, ZREG_H, SPECIFIC32),
       OPS(PREG_S, PG_Z, ZREG_S, SPECIFIC32),
       OPS(PREG_D, PG_Z, ZREG_D, SPECIFIC32));
  ...
  /** SVE Predicate Count */
  /*** SVE predicate count */
  PUT4(SVE_predicate_count0, NM("cntp"), OPS(XREG, PG, PREG_B),
       OPS(XREG, PG, PREG_H), OPS(XREG, PG, PREG_S), OPS(XREG, PG, PREG_D));

  void putSVE_predicate_count() { putSVE_predicate_count0(); }

  /** SVE Inc/Dec by Predicate Count */
  /*** SVE saturating inc/dec vector by predicate count */
  PUT3(SVE_saturating_inc_dec_vector_by_predicate_count0,
       NM("sqincp", "uqincp", "sqdecp", "uqdecp"), OPS(ZREG_H, PG),
       OPS(ZREG_S, PG), OPS(ZREG_D, PG));
  ...
  PUT4(SVE_saturating_inc_dec_register_by_predicate_count0,
       NM("sqincp", "sqdecp"), OPS(SPECIFIC32), OPS(SPECIFIC32_1),
       OPS(SPECIFIC32_2), OPS(SPECIFIC32_3));
  PUT4(SVE_saturating_inc_dec_register_by_predicate_count1,
       NM("sqincp", "sqdecp"), OPS(XREG, PREG_B), OPS(XREG, PREG_H),
       OPS(XREG, PREG_S), OPS(XREG, PREG_D));
  PUT4(SVE_saturating_inc_dec_register_by_predicate_count2,
       NM("uqincp", "uqdecp"), OPS(WREG, PREG_B), OPS(WREG, PREG_H),
       OPS(WREG, PREG_S), OPS(WREG, PREG_D));
  PUT4(SVE_saturating_inc_dec_register_by_predicate_count3,
       NM("uqincp", "uqdecp"), OPS(XREG, PREG_B), OPS(XREG, PREG_H),
       OPS(XREG, PREG_S), OPS(XREG, PREG_D));
  ...
  PUT3(SVE_inc_dec_vector_by_predicate_count0, NM("incp", "decp"),
  ...
  PUT4(SVE_inc_dec_register_by_predicate_count0, NM("incp", "decp"),
       OPS(XREG, PREG_B), OPS(XREG, PREG_H), OPS(XREG, PREG_S),
       OPS(XREG, PREG_D));
  ...
  PUT1(SVE_FFR_write_from_predicate0, NM("wrffr"), OPS(PREG_B));

  void putSVE_FFR_write_from_predicate() { putSVE_FFR_write_from_predicate0(); }

  /*** SVE FFR initialise */
  PUT0(SVE_FFR_initialise0, NM("setffr"));

  void putSVE_FFR_initialise() { putSVE_FFR_initialise0(); }

  /** SVE Integer Compare - Scalars */
  /*** SVE integer compare scalar count and limit */
  PUT8(SVE_integer_compare_scalar_count_and_limit0,
       NM("whilelt", "whilele", "whilelo", "whilels"), OPS(PREG_B, WREG, WREG),
       OPS(PREG_H, WREG, WREG), OPS(PREG_S, WREG, WREG),
       OPS(PREG_D, WREG, WREG), OPS(PREG_B, XREG, XREG),
       OPS(PREG_H, XREG, XREG), OPS(PREG_S, XREG, XREG),
       OPS(PREG_D, XREG, XREG));
  ...
  PUT2(SVE_conditionally_terminate_scalars0, NM("ctermeq", "ctermne"),
  ...
  PUT4(SVE_integer_min_max_immediate_unpredicated0, NM("smax", "smin"),
       OPS(SPECIFIC32, SPECIFIC64_3), OPS(SPECIFIC32_1, SPECIFIC64_3),
       OPS(SPECIFIC32_2, SPECIFIC64_3), OPS(SPECIFIC32_3, SPECIFIC64_3));
  PUT4(SVE_integer_min_max_immediate_unpredicated1, NM("umax", "umin"),
       OPS(SPECIFIC32, IMM8BIT), OPS(SPECIFIC32_1, IMM8BIT),
       OPS(SPECIFIC32_2, IMM8BIT), OPS(SPECIFIC32_3, IMM8BIT));
  ...
  PUT4(SVE_integer_multiply_immediate_unpredicated0, NM("mul"),
       OPS(SPECIFIC32, SPECIFIC64_3), OPS(SPECIFIC32_1, SPECIFIC64_3),
       OPS(SPECIFIC32_2, SPECIFIC64_3), OPS(SPECIFIC32_3, SPECIFIC64_3));
  ...
  PUT8(SVE_broadcast_integer_immediate_unpredicated0, NM("dup"),
  ...
  PUT3(SVE_broadcast_floating_point_immediate_unpredicated0, NM("fdup"),
  ...
  PUT2(SVE_integer_dot_product_unpredicated0, NM("sdot", "udot"),
  ...
  PUT1(SVE_integer_dot_product_indexed0, NM("sdot", "udot"),
       OPS(ZREG_S, ZREG_B, SPECIFIC32));
  PUT1(SVE_integer_dot_product_indexed1, NM("sdot", "udot"),
  ...
  PUT3(SVE_floating_point_complex_add_predicated0, NM("fcadd"),
  ...
  PUT3(SVE_floating_point_complex_multiply_add_predicated0, NM("fcmla"),
  ...
  /*** SVE floating-point multiply-add (indexed) */
  PUT1(SVE_floating_point_multiply_add_indexed0, NM("fmla", "fmls"),
       OPS(ZREG_H, ZREG_H, SPECIFIC32));
  PUT1(SVE_floating_point_multiply_add_indexed1, NM("fmla", "fmls"),
       OPS(ZREG_S, ZREG_S, SPECIFIC32_1));
  PUT1(SVE_floating_point_multiply_add_indexed2, NM("fmla", "fmls"),
  ...
  /*** SVE floating-point complex multiply-add (indexed) */
  PUT1(SVE_floating_point_complex_multiply_add_indexed0, NM("fcmla"),
       OPS(ZREG_H, ZREG_H, SPECIFIC32, SPECIFIC64));
  PUT1(SVE_floating_point_complex_multiply_add_indexed1, NM("fcmla"),
  ...
  /*** SVE floating-point multiply (indexed) */
  PUT1(SVE_floating_point_multiply_indexed0, NM("fmul"),
       OPS(ZREG_H, ZREG_H, SPECIFIC32));
  PUT1(SVE_floating_point_multiply_indexed1, NM("fmul"),
       OPS(ZREG_S, ZREG_S, SPECIFIC32_1));
  PUT1(SVE_floating_point_multiply_indexed2, NM("fmul"),
       OPS(ZREG_D, ZREG_D, SPECIFIC32_2));
  ...
  PUT3(SVE_floating_point_reciprocal_estimate_unpredicated0,
       NM("frecpe", "frsqrte"), OPS(ZREG_H, ZREG_H), OPS(ZREG_S, ZREG_S),
       OPS(ZREG_D, ZREG_D));
  ...
  PUT3(SVE_floating_point_serial_reduction_predicated0, NM("fadda"),
  ...
  PUT3(SVE_floating_point_trig_multiply_add_coefficient0, NM("ftmad"),
       OPS(SPECIFIC64, ZREG_H, IMM3BIT), OPS(SPECIFIC64_1, ZREG_S, IMM3BIT),
       OPS(SPECIFIC64_2, ZREG_D, IMM3BIT));
  ...
  PUT3(SVE_floating_point_arithmetic_with_immediate_predicated0,
       NM("fadd", "fsub", "fsubr"), OPS(SPECIFIC32, SPECIFIC32_3),
       OPS(SPECIFIC32_1, SPECIFIC32_3), OPS(SPECIFIC32_2, SPECIFIC32_3));

  PUT3(SVE_floating_point_arithmetic_with_immediate_predicated1, NM("fmul"),
       OPS(SPECIFIC32, SPECIFIC64_3), OPS(SPECIFIC32_1, SPECIFIC64_3),
       OPS(SPECIFIC32_2, SPECIFIC64_3));

  PUT3(SVE_floating_point_arithmetic_with_immediate_predicated2,
       NM("fmaxnm", "fminnm", "fmax", "fmin"), OPS(SPECIFIC32, SPECIFIC64_4),
       OPS(SPECIFIC32_1, SPECIFIC64_4), OPS(SPECIFIC32_2, SPECIFIC64_4));
  ...
  PUT6(SVE_floating_point_convert_precision0, NM("fcvt"),
       OPS(ZREG_H, PG_M, ZREG_S), OPS(ZREG_S, PG_M, ZREG_H),
       OPS(ZREG_H, PG_M, ZREG_D), OPS(ZREG_D, PG_M, ZREG_H),
       OPS(ZREG_S, PG_M, ZREG_D), OPS(ZREG_D, PG_M, ZREG_S));
  ...
  PUT3(SVE_floating_point_unary_operations0, NM("frecpx", "fsqrt"),
       OPS(ZREG_H, PG_M, ZREG_H), OPS(ZREG_S, PG_M, ZREG_S),
       OPS(ZREG_D, PG_M, ZREG_D));
  ...
  PUT1(SVE_integer_convert_to_floating_point0, NM("scvtf", "ucvtf"),
       OPS(ZREG_H, PG_M, ZREG_H));
  PUT1(SVE_integer_convert_to_floating_point1, NM("scvtf", "ucvtf"),
       OPS(ZREG_H, PG_M, ZREG_S));
  PUT1(SVE_integer_convert_to_floating_point2, NM("scvtf", "ucvtf"),
       OPS(ZREG_H, PG_M, ZREG_D));
  PUT1(SVE_integer_convert_to_floating_point3, NM("scvtf", "ucvtf"),
       OPS(ZREG_S, PG_M, ZREG_S));
  PUT1(SVE_integer_convert_to_floating_point4, NM("scvtf", "ucvtf"),
       OPS(ZREG_D, PG_M, ZREG_S));
  PUT1(SVE_integer_convert_to_floating_point5, NM("scvtf", "ucvtf"),
       OPS(ZREG_S, PG_M, ZREG_D));
  PUT1(SVE_integer_convert_to_floating_point6, NM("scvtf", "ucvtf"),
       OPS(ZREG_D, PG_M, ZREG_D));
  ...
  PUT1(SVE_floating_point_convert_to_integer0, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_H, PG_M, ZREG_H));
  PUT1(SVE_floating_point_convert_to_integer1, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_S, PG_M, ZREG_H));
  PUT1(SVE_floating_point_convert_to_integer2, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_D, PG_M, ZREG_H));
  PUT1(SVE_floating_point_convert_to_integer3, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_S, PG_M, ZREG_S));
  PUT1(SVE_floating_point_convert_to_integer4, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_S, PG_M, ZREG_D));
  PUT1(SVE_floating_point_convert_to_integer5, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_D, PG_M, ZREG_S));
  PUT1(SVE_floating_point_convert_to_integer6, NM("fcvtzs", "fcvtzu"),
       OPS(ZREG_D, PG_M, ZREG_D));
  ...
  PUT3(SVE_floating_point_multiply_accumulate_writing_addend0,
       NM("fmla", "fmls", "fnmla", "fnmls"), OPS(ZREG_H, PG_M, ZREG_H, ZREG_H),
  ...
  PUT3(SVE_floating_point_multiply_accumulate_writing_multiplicand0,
       NM("fmad", "fmsb", "fnmad", "fnmsb"), OPS(ZREG_H, PG_M, ZREG_H, ZREG_H),
       OPS(ZREG_S, PG_M, ZREG_S, ZREG_S), OPS(ZREG_D, PG_M, ZREG_D, ZREG_D));
  ...
  void putSVE_StackAllocation() {
    std::vector<int> tmp = {-15, -32, -16, -8, -4, -2, -1,
                            0,   1,   2,   4,  8,  16, 31};
  ...
  void putSVE_AddressGenerationGroup() {
    std::vector<std::string> tmpReg = {"z15", "z0", "z1",  "z2", "z3",
                                       "z4",  "z8", "z16", "z31"};
    ...
    for (std::string i : tmpReg) {
      ...
      jtv_SPECIFIC32_1.push_back("ptr(" + i + ".s, " + tmpReg[0] +
                                 ".s, LSL, 1)");
      ...
      jtv_SPECIFIC32_2.push_back("ptr(" + i + ".d, " + tmpReg[0] +
                                 ".d, LSL, 1)");
    ...
    for (std::string i : tmpReg) {
      ...
      jtv_SPECIFIC32_1.push_back("ptr(" + tmpReg[0] + ".s, " + i +
                                 ".s, LSL, 1)");
      ...
      jtv_SPECIFIC32_2.push_back("ptr(" + tmpReg[0] + ".d, " + i +
                                 ".d, LSL, 1)");
  ...
  void putSVE_ElementCount() {
    ...
    for (int i : tmpIdx) {
      tv_SPECIFIC32_1.push_back("x" + std::to_string(i) + ", w" +
                                std::to_string(i));
  ...
  void putSVE_BitwiseImmediate() {
    ...
    for (int i : tmpIdx) {
      tv_SPECIFIC32.push_back("z" + std::to_string(i) + ".b, " + "z" +
                              std::to_string(i) + ".b");
      tv_SPECIFIC32_1.push_back("z" + std::to_string(i) + ".h, " + "z" +
                                std::to_string(i) + ".h");
      tv_SPECIFIC32_2.push_back("z" + std::to_string(i) + ".s, " + "z" +
                                std::to_string(i) + ".s");
      tv_SPECIFIC32_3.push_back("z" + std::to_string(i) + ".d, " + "z" +
                                std::to_string(i) + ".d");
  ...
  void putSVE_IntegerWideImmediatePredicated() {
    std::vector<int> tmp = {127, -128, -64, -32, -16, -8, -4, -2, -1,
                            0,   1,    2,   4,   8,   16, 32, 64};
    tv_SPECIFIC32.clear();
    tv_SPECIFIC64.clear();
    tv_SPECIFIC64_1.clear();
  ...
  void putSVE_PermuteVectorInterleaving() { putSVE_permute_vector_elements(); }
  ...
  void putSVE_PermuteVectorPredicated() {
    ...
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_1, jtv_SPECIFIC32_1, "h",
                         tv_ZREG);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_2, jtv_SPECIFIC32_2, "s",
                         tv_ZREG);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_3, jtv_SPECIFIC32_3, "d",
                         tv_ZREG);
    ...
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC64_1, jtv_SPECIFIC64_1, "",
                         tv_ZREG_H);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC64_2, jtv_SPECIFIC64_2, "",
                         tv_ZREG_S);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC64_3, jtv_SPECIFIC64_3, "",
                         tv_ZREG_D);
    ...
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_4, jtv_SPECIFIC32_4, "",
                         tv_WREG);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC64_4, jtv_SPECIFIC64_4, "",
                         tv_XREG);
  ...
  void putSVE_VectorSelect() { putSVE_select_vector_elements_predicated(); }
  ...
  void putSVE_PartitionBreak() {
    ...
    for (std::string i : tv_PG_Z) {
      std::string tmp =
          tv_PREG_B[0] + ", " + i + ", " + tv_PREG_B[0] + ", " + tv_PREG_B[0];
      tv_SPECIFIC32.push_back(tmp);
    }
    ...
    for (std::string i : tv_PREG_B) {
      std::string tmp =
          tv_PREG_B[0] + ", " + tv_PG_Z[0] + ", " + i + ", " + tv_PREG_B[0];
  ...
  void putSVE_PredicateMisc() {
    ...
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_1, jtv_SPECIFIC32_1, "",
                         tv_PREG_H);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_2, jtv_SPECIFIC32_2, "",
                         tv_PREG_S);
    setDstPred1stSrcZreg(TP_NONE, tv_SPECIFIC32_3, jtv_SPECIFIC32_3, "",
                         tv_PREG_D);
  ...
  void putSVE_PredicateCount() { putSVE_predicate_count(); }
  ...
  void putSVE_IncDecbyPredicateCount() {
    ...
    /** Dst register rotation */
    for (int i : tmpIdx) {
      tv_SPECIFIC32.push_back("x" + std::to_string(i) + ", " + tv_PREG_B[0] +
                              ", w" + std::to_string(i));
      jtv_SPECIFIC32.push_back("w" + std::to_string(i) + ", " + tv_PREG_B[0]);
      tv_SPECIFIC32_1.push_back("x" + std::to_string(i) + ", " + tv_PREG_H[0] +
                                ", w" + std::to_string(i));
      jtv_SPECIFIC32_1.push_back("w" + std::to_string(i) + ", " + tv_PREG_H[0]);
      tv_SPECIFIC32_2.push_back("x" + std::to_string(i) + ", " + tv_PREG_S[0] +
                                ", w" + std::to_string(i));
      jtv_SPECIFIC32_2.push_back("w" + std::to_string(i) + ", " + tv_PREG_S[0]);
      tv_SPECIFIC32_3.push_back("x" + std::to_string(i) + ", " + tv_PREG_D[0] +
                                ", w" + std::to_string(i));
      jtv_SPECIFIC32_3.push_back("w" + std::to_string(i) + ", " + tv_PREG_D[0]);
    }
    /** Predicate register rotation */
    for (size_t i = 0; i < tv_PREG_B.size(); i++) {
      tv_SPECIFIC32.push_back("x" + std::to_string(tmpIdx[0]) + ", " +
                              tv_PREG_B[i] +
                              ", "
                              "w" +
                              std::to_string(tmpIdx[0]));
      jtv_SPECIFIC32.push_back("w" + std::to_string(tmpIdx[0]) + ", " +
                               tv_PREG_B[i]);
      tv_SPECIFIC32_1.push_back("x" + std::to_string(tmpIdx[0]) + ", " +
                                tv_PREG_H[i] +
                                ", "
                                "w" +
                                std::to_string(tmpIdx[0]));
      jtv_SPECIFIC32_1.push_back("w" + std::to_string(tmpIdx[0]) + ", " +
                                 tv_PREG_H[i]);
      tv_SPECIFIC32_2.push_back("x" + std::to_string(tmpIdx[0]) + ", " +
                                tv_PREG_S[i] +
                                ", "
                                "w" +
                                std::to_string(tmpIdx[0]));
      jtv_SPECIFIC32_2.push_back("w" + std::to_string(tmpIdx[0]) + ", " +
                                 tv_PREG_S[i]);
      tv_SPECIFIC32_3.push_back("x" + std::to_string(tmpIdx[0]) + ", " +
                                tv_PREG_D[i] +
                                ", "
                                "w" +
                                std::to_string(tmpIdx[0]));
      jtv_SPECIFIC32_3.push_back("w" + std::to_string(tmpIdx[0]) + ", " +
                                 tv_PREG_D[i]);
    }
  ...
  void putSVE_MultiplyIndexed() {
    ...
    std::vector<std::string> tmpReg64 = {"z7", "z0", "z1", "z2",
                                         "z4", "z8", "z15"};
  ...
  void putSVE_FloatingPointComplexAddition() {
    std::vector<std::string> tmpDst = {"z15", "z0", "z1",  "z2",
                                       "z4",  "z8", "z16", "z31"};
    tv_SPECIFIC32.clear();
    jtv_SPECIFIC32.clear();
  ...
  void putSVE_FloatingPointMultiplyAddIndexed() {
    ...
    std::vector<std::string> zreg1 = {"z3.", "z0.", "z1.", "z2.",
                                      "z4.", "z8.", "z15."};
